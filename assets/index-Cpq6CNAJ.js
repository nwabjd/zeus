...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function To(e,t,n){let r=new Float32Array(uo),i=new U(0,1,0);return new ia({name:`SphericalGaussianBlur`,defines:{n:uo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Oo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Eo(){return new ia({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Oo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Do(){return new ia({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Oo(),fragmentShader:`
	...
	`}var ko=class extends vn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Wi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,fragmentShader:j,uniforms:this.uniforms});this.line=new Ui(e,n),this.scene.add(this.line)}update({dt:e,isBounce:t,BFECC:n}){this.uniforms.dt.value=e,this.line.visible=t,this.uniforms.isBFECC.value=n,super.update()}}class M extends ne{constructor(e){super({output:e.dst}),this.init(e)}init(e){super.init();let t=new Yi(1,1),n=new aa({vertexShader:`
    precision highp float;
    attribute vec3 position;
    attribute vec2 uv;
    uniform vec2 center;
...
`,transparent:!0,depthWrite:!1,uniforms:{velocity:{value:this.simulation.fbos.vel_0.texture},boundarySpace:{value:new H},palette:{value:f},bgColor:{value:C}}})),this.scene.add(this.output)}addScene(e){this.scene.add(e)}resize(){this.simulation.resize()}render(){O.renderer.setRenderTarget(null),O.renderer.render(this.scene,this.camera)}update(){this.simulation.update(),this.render()}}class P{constructor(e){this.props=e,O.init(e.$wrapper),A.init(e.$wrapper),A.autoIntensity=e.autoIntensity,A.takeoverDuration=e.takeoverDuration,this.lastUserInteraction=performance.now(),A.onInteract=()=>{this.lastUserInteraction=performance.now(),this.autoDriver&&this.autoDriver.forceStop()},this.autoDriver=new ee(A,this,{enabled:e.autoDemo,speed:e.autoSpeed,resumeDelay:e.autoResumeDelay,rampDuration:e.autoRampDuration}),this.init(),this._loop=this.loop.bind(this),this._resize=this.resize.bind(this),window.addEventListener(`resize`,this._resize),this._onVisibility=()=>{document.hidden?this.pause():T.current&&this.start()},document.addEventListener(`visibilitychange`,this._onVisibility),this.running=!1}init(){this.props.$wrapper.prepend(O.renderer.domElement),this.output=new ce}resize(){O.resize(),this.output.resize()}render(){this.autoDriver&&this.autoDriver.update(),A.update(),O.update(),this.output.update()}loop(){this.running&&(this.render(),S.current=requestAnimationFrame(this._loop))}start(){this.running||(this.running=!0,this._loop())}pause(){this.running=!1,S.current&&=(cancelAnimationFrame(S.current),null)}dispose(){try{if(window.removeEventListener(`resize`,this._resize),document.removeEventListener(`visibilitychange`,this._onVisibility),A.dispose(),O.renderer){let e=O.renderer.domElement;e&&e.parentNode&&e.parentNode.removeChild(e),O.renderer.dispose(),O.renderer.forceContextLoss()}}catch{}}}let le=y.current;le.style.position=le.style.position||`relative`,le.style.overflow=le.style.overflow||`hidden`;let ue=new P({$wrapper:le,autoDemo:p,autoSpeed:m,autoIntensity:h,takeoverDuration:g,autoResumeDelay:_,autoRampDuration:v});b.current=ue,(()=>{if(!b.current)return;let u=b.current.output?.simulation;if(!u)return;let d=u.options.resolution;Object.assign(u.options,{mouse_force:e,cursor_size:t,isViscous:n,viscous:r,iterations_viscous:i,iterations_poisson:a,dt:o,BFECC:s,resolution:c,isBounce:l}),c!==d&&u.resize()})(),ue.start();let de=new IntersectionObserver(e=>{let t=e[0],n=t.isIntersecting&&t.intersectionRatio>0;T.current=n,b.current&&(n&&!document.hidden?b.current.start():b.current.pause())},{threshold:[0,.01,.1]});de.observe(le),w.current=de;let fe=new ResizeObserver(()=>{b.current&&(E.current&&cancelAnimationFrame(E.current),E.current=requestAnimationFrame(()=>{b.current&&b.current.resize()}))});return fe.observe(le),x.current=fe,()=>{if(S.current&&cancelAnimationFrame(S.current),x.current)try{x.current.disconnect()}catch{}if(w.current)try{w.current.disconnect()}catch{}b.current&&b.current.dispose(),b.current=null}},[s,t,o,l,n,a,i,e,c,r,u,p,m,h,g,_,v]),(0,C.useEffect)(()=>{let u=b.current;if(!u)return;let d=u.output?.simulation;if(!d)return;let f=d.options.resolution;Object.assign(d.options,{mouse_force:e,cursor_size:t,isViscous:n,viscous:r,iterations_viscous:i,iterations_poisson:a,dt:o,BFECC:s,resolution:c,isBounce:l}),u.autoDriver&&(u.autoDriver.enabled=p,u.autoDriver.speed=m,u.autoDriver.resumeDelay=_,u.autoDriver.rampDurationMs=v*1e3,u.autoDriver.mouse&&(u.autoDriver.mouse.autoIntensity=h,u.autoDriver.mouse.takeoverDuration=g)),c!==f&&d.resize()},[e,t,n,r,i,a,o,s,c,l,p,m,h,g,_,v]),(0,Z.jsx)(`div`,{ref:y,className:`liquid-ether-container ${f||``}`,style:d})}var gl=`
void main() {
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}
`,_l=`
...
`;function vl({color:e=`#fc42ff`,colorTwo:t=`#42fcff`,speed:n=1,ringCount:r=6,attenuation:i=10,lineThickness:a=2,baseRadius:o=.35,radiusStep:s=.1,scaleRate:c=.1,opacity:l=1,blur:u=0,noiseAmount:d=.1,rotation:f=0,ringGap:p=1.5,fadeIn:m=.7,fadeOut:h=.5,followMouse:g=!1,mouseInfluence:_=.2,hoverScale:v=1.2,parallax:y=.05,clickBurst:b=!1}){let x=(0,C.useRef)(null),S=(0,C.useRef)(null),w=(0,C.useRef)([0,0]),T=(0,C.useRef)([0,0]),E=(0,C.useRef)(0),D=(0,C.useRef)(!1),O=(0,C.useRef)(0);return S.current={color:e,colorTwo:t,speed:n,ringCount:r,attenuation:i,lineThickness:a,baseRadius:o,radiusStep:s,scaleRate:c,opacity:l,noiseAmount:d,rotation:f,ringGap:p,fadeIn:m,fadeOut:h,followMouse:g,mouseInfluence:_,hoverScale:v,parallax:y,clickBurst:b},(0,C.useEffect)(()=>{let e=x.current;if(!e)return;let t;try{t=new pl({alpha:!0})}catch{return}if(!t.capabilities.isWebGL2){t.dispose();return}t.setClearColor(0,0),e.appendChild(t.domElement);let n=new rr,r=new Ma(-.5,.5,.5,-.5,.1,10);r.position.z=1;let i={uTime:{value:0},uAttenuation:{value:0},uResolution:{value:new H},uColor:{value:new K},uColorTwo:{value:new K},uLineThickness:{value:0},uBaseRadius:{value:0},uRadiusStep:{value:0},uScaleRate:{value:0},uRingCount:{value:0},uOpacity:{value:1},uNoiseAmount:{value:0},uRotation:{value:0},uRingGap:{value:1.6},uFadeIn:{value:.5},uFadeOut:{value:.75},uMouse:{value:new H},uMouseInfluence:{value:0},uHoverAmount:{value:0},uHoverScale:{value:1},uParallax:{value:0},uBurst:{value:0}},a=new ia({vertexShader:gl,fragmentShader:_l,uniforms:i,transparent:!0}),o=new bi(new Yi(1,1),a);n.add(o);let s=()=>{let n=e.clientWidth,r=e.clientHeight,a=Math.min(window.devicePixelRatio,2);t.setSize(n,r),t.setPixelRatio(a),i.uResolution.value.set(n*a,r*a)};s(),window.addEventListener(`resize`,s);let c=new ResizeObserver(s);c.observe(e);let l=t=>{let n=e.getBoundingClientRect();w.current[0]=(t.clientX-n.left)/n.width-.5,w.current[1]=-((t.clientY-n.top)/n.height-.5)},u=()=>{D.current=!0},d=()=>{D.current=!1,w.current[0]=0,w.current[1]=0},f=()=>{O.current=1};e.addEventListener(`mousemove`,l),e.addEventListener(`mouseenter`,u),e.addEventListener(`mouseleave`,d),e.addEventListener(`click`,f);let p,m=e=>{p=requestAnimationFrame(m);let a=S.current;T.current[0]+=(w.current[0]-T.current[0])*.08,T.current[1]+=(w.current[1]-T.current[1])*.08,E.current+=(+!!D.current-E.current)*.08,O.current*=.95,O.current<.001&&(O.current=0),i.uTime.value=e*.001*a.speed,i.uAttenuation.value=a.attenuation,i.uColor.value.set(a.color),i.uColorTwo.value.set(a.colorTwo),i.uLineThickness.value=a.lineThickness,i.uBaseRadius.value=a.baseRadius,i.uRadiusStep.value=a.radiusStep,i.uScaleRate.value=a.scaleRate,i.uRingCount.value=a.ringCount,i.uOpacity.value=a.opacity,i.uNoiseAmount.value=a.noiseAmount,i.uRotation.value=a.rotation*Math.PI/180,i.uRingGap.value=a.ringGap,i.uFadeIn.value=a.fadeIn,i.uFadeOut.value=a.fadeOut,i.uMouse.value.set(T.current[0],T.current[1]),i.uMouseInfluence.value=a.followMouse?a.mouseInfluence:0,i.uHoverAmount.value=E.current,i.uHoverScale.value=a.hoverScale,i.uParallax.value=a.parallax,i.uBurst.value=a.clickBurst?O.current:0,t.render(n,r)};return p=requestAnimationFrame(m),()=>{cancelAnimationFrame(p),window.removeEventListener(`resize`,s),c.disconnect(),e.removeEventListener(`mousemove`,l),e.removeEventListener(`mouseenter`,u),e.removeEventListener(`mouseleave`,d),e.removeEventListener(`click`,f),e.removeChild(t.domElement),t.dispose(),a.dispose()}},[]),(0,Z.jsx)(`div`,{ref:x,className:`magic-rings-container`,style:u>0?{filter:`blur(${u}px)`}:void 0})}function yl(e){let t=e[0],n=e[1],r=e[2];return Math.sqrt(t*t+n*n+r*r)}function bl(e,t){return e[0]=t[0],e[1]=t[1],e[2]=t[2],e}function xl(e,t,n,r){return e[0]=t,e[1]=n,e[2]=r,e}function Sl(e,t,n){return e[0]=t[0]+n[0],e[1]=t[1]+n[1],e[2]=t[2]+n[2],e}function Cl(e,t,n){return e[0]=t[0]-n[0],e[1]=t[1]-n[1],e[2]=t[2]-n[2],e}function wl(e,t,n){return e[0]=t[0]*n[0],e[1]=t[1]*n[1],e[2]=t[2]*n[2],e}function Tl(e,t,n){return e[0]=t[0]/n[0],e[1]=t[1]/n[1],e[2]=t[2]/n[2],e}function El(e,t,n){return e[0]=t[0]*n,e[1]=t[1]*n,e[2]=t[2]*n,e}function Dl(e,t){let n=t[0]-e[0],r=t[1]-e[1],i=t[2]-e[2];return Math.sqrt(n*n+r*r+i*i)}function Ol(e,t){let n=t[0]-e[0],r=t[1]-e[1],i=t[2]-e[2];return n*n+r*r+i*i}function kl(e){let t=e[0],n=e[1],r=e[2];return t*t+n*n+r*r}function Al(e,t){return e[0]=-t[0],e[1]=-t[1],e[2]=-t[2],e}function jl(e,t){return e[0]=1/t[0],e[1]=1/t[1],e[2]=1/t[2],e}function Ml(e,t){let n=t[0],r=t[1],i=t[2],a=n*n+r*r+i*i;return a>0&&(a=1/Math.sqrt(a)),e[0]=t[0]*a,e[1]=t[1]*a,e[2]=t[2]*a,e}function Nl(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]}function Pl(e,t,n){let r=t[0],i=t[1],a=t[2],o=n[0],s=n[1],c=n[2];return e[0]=i*c-a*s,e[1]=a*o-r*c,e[2]=r*s-i*o,e}function Q(e,t,n,r){let i=t[0],a=t[1],o=t[2];return e[0]=i+r*(n[0]-i),e[1]=a+r*(n[1]-a),e[2]=o+r*(n[2]-o),e}function Fl(e,t,n,r,i){let a=Math.exp(-r*i),o=t[0],s=t[1],c=t[2];return e[0]=n[0]+(o-n[0])*a,e[1]=n[1]+(s-n[1])*a,e[2]=n[2]+(c-n[2])*a,e}function Il(e,t,n){let r=t[0],i=t[1],a=t[2],o=n[3]*r+n[7]*i+n[11]*a+n[15];return o||=1,e[0]=(n[0]*r+n[4]*i+n[8]*a+n[12])/o,e[1]=(n[1]*r+n[5]*i+n[9]*a+n[13])/o,e[2]=(n[2]*r+n[6]*i+n[10]*a+n[14])/o,e}function Ll(e,t,n){let r=t[0],i=t[1],a=t[2],o=n[3]*r+n[7]*i+n[11]*a+n[15];return o||=1,e[0]=(n[0]*r+n[4]*i+n[8]*a)/o,e[1]=(n[1]*r+n[5]*i+n[9]*a)/o,e[2]=(n[2]*r+n[6]*i+n[10]*a)/o,e}function Rl(e,t,n){let r=t[0],i=t[1],a=t[2];return e[0]=r*n[0]+i*n[3]+a*n[6],e[1]=r*n[1]+i*n[4]+a*n[7],e[2]=r*n[2]+i*n[5]+a*n[8],e}function zl(e,t,n){let r=t[0],i=t[1],a=t[2],o=n[0],s=n[1],c=n[2],l=n[3],u=s*a-c*i,d=c*r-o*a,f=o*i-s*r,p=s*f-c*d,m=c*u-o*f,h=o*d-s*u,g=l*2;return u*=g,d*=g,f*=g,p*=2,m*=2,h*=2,e[0]=r+u+p,e[1]=i+d+m,e[2]=a+f+h,e}var Bl=(function(){let e=[0,0,0],t=[0,0,0];return function(n,r){bl(e,n),bl(t,r),Ml(e,e),Ml(t,t);let i=Nl(e,t);return i>1?0:i<-1?Math.PI:Math.acos(i)}})();function Vl(e,t){return e[0]===t[0]&&e[1]===t[1]&&e[2]===t[2]}var Hl=class e extends Array{constructor(e=0,t=e,n=e){return super(e,t,n),this}get x(){return this[0]}get y(){return this[1]}get z(){return this[2]}set x(e){this[0]=e}set y(e){this[1]=e}set z(e){this[2]=e}set(e,t=e,n=e){return e.length?this.copy(e):(xl(this,e,t,n),this)}copy(e){return bl(this,e),this}add(e,t){return t?Sl(this,e,t):Sl(this,this,e),this}sub(e,t){return t?Cl(this,e,t):Cl(this,this,e),this}multiply(e){return e.length?wl(this,this,e):El(this,this,e),this}divide(e){return e.length?Tl(this,this,e):El(this,this,1/e),this}inverse(e=this){return jl(this,e),this}len(){return yl(this)}distance(e){return e?Dl(this,e):yl(this)}squaredLen(){return kl(this)}squaredDistance(e){return e?Ol(this,e):kl(this)}negate(e=this){return Al(this,e),this}cross(e,t){return t?Pl(this,e,t):Pl(this,this,e),this}scale(e){return El(this,this,e),this}normalize(){return Ml(this,this),this}dot(e){return Nl(this,e)}equals(e){return Vl(this,e)}applyMatrix3(e){return Rl(this,this,e),this}applyMatrix4(e){return Il(this,this,e),this}scaleRotateMatrix4(e){return Ll(this,this,e),this}applyQuaternion(e){return zl(this,this,e),this}angle(e){return Bl(this,e)}lerp(e,t){return Q(this,this,e,t),this}smoothLerp(e,t,n){return Fl(this,this,e,t,n),this}clone(){return new e(this[0],this[1],this[2])}fromArray(e,t=0){return this[0]=e[t],this[1]=e[t+1],this[2]=e[t+2],this}toArray(e=[],t=0){return e[t]=this[0],e[t+1]=this[1],e[t+2]=this[2],e}transformDirection(e){let t=this[0],n=this[1],r=this[2];return this[0]=e[0]*t+e[4]*n+e[8]*r,this[1]=e[1]*t+e[5]*n+e[9]*r,this[2]=e[2]*t+e[6]*n+e[10]*r,this.normalize()}},Ul=new Hl,Wl=1,Gl=1,Kl=!1,ql=class{constructor(e,t={}){e.canvas||console.error(`gl not passed as first argument to Geometry`),this.gl=e,this.attributes=t,this.id=Wl++,this.VAOs={},this.drawRange={start:0,count:0},this.instancedCount=0,this.gl.renderer.bindVertexArray(null),this.gl.renderer.currentGeometry=null,this.glState=this.gl.renderer.state;for(let e in t)this.addAttribute(e,t[e])}addAttribute(e,t){if(this.attributes[e]=t,t.id=Gl++,t.size=t.size||1,t.type=t.type||(t.data.constructor===Float32Array?this.gl.FLOAT:t.data.constructor===Uint16Array?this.gl.UNSIGNED_SHORT:this.gl.UNSIGNED_INT),t.target=e===`index`?this.gl.ELEMENT_ARRAY_BUFFER:this.gl.ARRAY_BUFFER,t.normalized=t.normalized||!1,t.stride=t.stride||0,t.offset=t.offset||0,t.count=t.count||(t.stride?t.data.byteLength/t.stride:t.data.length/t.size),t.divisor=t.instanced||0,t.needsUpdate=!1,t.usage=t.usage||this.gl.STATIC_DRAW,t.buffer||this.updateAttribute(t),t.divisor){if(this.isInstanced=!0,this.instancedCount&&this.instancedCount!==t.count*t.divisor)return console.warn(`geometry has multiple instanced buffers of different length`),this.instancedCount=Math.min(this.instancedCount,t.count*t.divisor);this.instancedCount=t.count*t.divisor}else e===`index`?this.drawRange.count=t.count:this.attributes.index||(this.drawRange.count=Math.max(this.drawRange.count,t.count))}updateAttribute(e){let t=!e.buffer;t&&(e.buffer=this.gl.createBuffer()),this.glState.boundBuffer!==e.buffer&&(this.gl.bindBuffer(e.target,e.buffer),this.glState.boundBuffer=e.buffer),t?this.gl.bufferData(e.target,e.data,e.usage):this.gl.bufferSubData(e.target,0,e.data),e.needsUpdate=!1}setIndex(e){this.addAttribute(`index`,e)}setDrawRange(e,t){this.drawRange.start=e,this.drawRange.count=t}setInstancedCount(e){this.instancedCount=e}createVAO(e){this.VAOs[e.attributeOrder]=this.gl.renderer.createVertexArray(),this.gl.renderer.bindVertexArray(this.VAOs[e.attributeOrder]),this.bindAttributes(e)}bindAttributes(e){e.attributeLocations.forEach((e,{name:t,type:n})=>{if(!this.attributes[t]){console.warn(`active attribute ${t} not being supplied`);return}let r=this.attributes[t];this.gl.bindBuffer(r.target,r.buffer),this.glState.boundBuffer=r.buffer;let i=1;n===35674&&(i=2),n===35675&&(i=3),n===35676&&(i=4);let a=r.size/i,o=i===1?0:i*i*4,s=i===1?0:i*4;for(let t=0;t<i;t++)this.gl.vertexAttribPointer(e+t,a,r.type,r.normalized,r.stride+o,r.offset+t*s),this.gl.enableVertexAttribArray(e+t),this.gl.renderer.vertexAttribDivisor(e+t,r.divisor)}),this.attributes.index&&this.gl.bindBuffer(this.gl.ELEMENT_ARRAY_BUFFER,this.attributes.index.buffer)}draw({program:e,mode:t=this.gl.TRIANGLES}){this.gl.renderer.currentGeometry!==`${this.id}_${e.attributeOrder}`&&(this.VAOs[e.attributeOrder]||this.createVAO(e),this.gl.renderer.bindVertexArray(this.VAOs[e.attributeOrder]),this.gl.renderer.currentGeometry=`${this.id}_${e.attributeOrder}`),e.attributeLocations.forEach((e,{name:t})=>{let n=this.attributes[t];n.needsUpdate&&this.updateAttribute(n)});let n=2;this.attributes.index?.type===this.gl.UNSIGNED_INT&&(n=4),this.isInstanced?this.attributes.index?this.gl.renderer.drawElementsInstanced(t,this.drawRange.count,this.attributes.index.type,this.attributes.index.offset+this.drawRange.start*n,this.instancedCount):this.gl.renderer.drawArraysInstanced(t,this.drawRange.start,this.drawRange.count,this.instancedCount):this.attributes.index?this.gl.drawElements(t,this.drawRange.count,this.attributes.index.type,this.attributes.index.offset+this.drawRange.start*n):this.gl.drawArrays(t,this.drawRange.start,this.drawRange.count)}getPosition(){let e=this.attributes.position;if(e.data)return e;if(!Kl)return console.warn(`No position buffer data found to compute bounds`),Kl=!0}computeBoundingBox(e){e||=this.getPosition();let t=e.data,n=e.size;this.bounds||={min:new Hl,max:new Hl,center:new Hl,scale:new Hl,radius:1/0};let r=this.bounds.min,i=this.bounds.max,a=this.bounds.center,o=this.bounds.scale;r.set(1/0),i.set(-1/0);for(let e=0,a=t.length;e<a;e+=n){let n=t[e],a=t[e+1],o=t[e+2];r.x=Math.min(n,r.x),r.y=Math.min(a,r.y),r.z=Math.min(o,r.z),i.x=Math.max(n,i.x),i.y=Math.max(a,i.y),i.z=Math.max(o,i.z)}o.sub(i,r),a.add(r,i).divide(2)}computeBoundingSphere(e){e||=this.getPosition();let t=e.data,n=e.size;this.bounds||this.computeBoundingBox(e);let r=0;for(let e=0,i=t.length;e<i;e+=n)Ul.fromArray(t,e),r=Math.max(r,this.bounds.center.squaredDistance(Ul));this.bounds.radius=Math.sqrt(r)}remove(){for(let e in this.VAOs)this.gl.renderer.deleteVertexArray(this.VAOs[e]),delete this.VAOs[e];for(let e in this.attributes)this.gl.deleteBuffer(this.attributes[e].buffer),delete this.attributes[e]}},Jl=1,Yl={},Xl=class{constructor(e,{vertex:t,fragment:n,uniforms:r={},transparent:i=!1,cullFace:a=e.BACK,frontFace:o=e.CCW,depthTest:s=!0,depthWrite:c=!0,depthFunc:l=e.LEQUAL}={}){e.canvas||console.error(`gl not passed as first argument to Program`),this.gl=e,this.uniforms=r,this.id=Jl++,t||console.warn(`vertex shader not supplied`),n||console.warn(`fragment shader not supplied`),this.transparent=i,this.cullFace=a,this.frontFace=o,this.depthTest=s,this.depthWrite=c,this.depthFunc=l,this.blendFunc={},this.blendEquation={},this.stencilFunc={},this.stencilOp={},this.transparent&&!this.blendFunc.src&&(this.gl.renderer.premultipliedAlpha?this.setBlendFunc(this.gl.ONE,this.gl.ONE_MINUS_SRC_ALPHA):this.setBlendFunc(this.gl.SRC_ALPHA,this.gl.ONE_MINUS_SRC_ALPHA)),this.vertexShader=e.createShader(e.VERTEX_SHADER),this.fragmentShader=e.createShader(e.FRAGMENT_SHADER),this.program=e.createProgram(),e.attachShader(this.program,this.vertexShader),e.attachShader(this.program,this.fragmentShader),this.setShaders({vertex:t,fragment:n})}setShaders({vertex:e,fragment:t}){if(e&&(this.gl.shaderSource(this.vertexShader,e),this.gl.compileShader(this.vertexShader),this.gl.getShaderInfoLog(this.vertexShader)!==``&&console.warn(`${this.gl.getShaderInfoLog(this.vertexShader)}\nVertex Shader\n${Ql(e)}`)),t&&(this.gl.shaderSource(this.fragmentShader,t),this.gl.compileShader(this.fragmentShader),this.gl.getShaderInfoLog(this.fragmentShader)!==``&&console.warn(`${this.gl.getShaderInfoLog(this.fragmentShader)}\nFragment Shader\n${Ql(t)}`)),this.gl.linkProgram(this.program),!this.gl.getProgramParameter(this.program,this.gl.LINK_STATUS))return console.warn(this.gl.getProgramInfoLog(this.program));this.uniformLocations=new Map;let n=this.gl.getProgramParameter(this.program,this.gl.ACTIVE_UNIFORMS);for(let e=0;e<n;e++){let t=this.gl.getActiveUniform(this.program,e);this.uniformLocations.set(t,this.gl.getUniformLocation(this.program,t.name));let n=t.name.match(/(\w+)/g);t.uniformName=n[0],t.nameComponents=n.slice(1)}this.attributeLocations=new Map;let r=[],i=this.gl.getProgramParameter(this.program,this.gl.ACTIVE_ATTRIBUTES);for(let e=0;e<i;e++){let t=this.gl.getActiveAttrib(this.program,e),n=this.gl.getAttribLocation(this.program,t.name);n!==-1&&(r[n]=t.name,this.attributeLocations.set(t,n))}this.attributeOrder=r.join(``)}setBlendFunc(e,t,n,r){this.blendFunc.src=e,this.blendFunc.dst=t,this.blendFunc.srcAlpha=n,this.blendFunc.dstAlpha=r,e&&(this.transparent=!0)}setBlendEquation(e,t){this.blendEquation.modeRGB=e,this.blendEquation.modeAlpha=t}setStencilFunc(e,t,n){this.stencilRef=t,this.stencilFunc.func=e,this.stencilFunc.ref=t,this.stencilFunc.mask=n}setStencilOp(e,t,n){this.stencilOp.stencilFail=e,this.stencilOp.depthFail=t,this.stencilOp.depthPass=n}applyState(){this.depthTest?this.gl.renderer.enable(this.gl.DEPTH_TEST):this.gl.renderer.disable(this.gl.DEPTH_TEST),this.cullFace?this.gl.renderer.enable(this.gl.CULL_FACE):this.gl.renderer.disable(this.gl.CULL_FACE),this.blendFunc.src?this.gl.renderer.enable(this.gl.BLEND):this.gl.renderer.disable(this.gl.BLEND),this.cullFace&&this.gl.renderer.setCullFace(this.cullFace),this.gl.renderer.setFrontFace(this.frontFace),this.gl.renderer.setDepthMask(this.depthWrite),this.gl.renderer.setDepthFunc(this.depthFunc),this.blendFunc.src&&this.gl.renderer.setBlendFunc(this.blendFunc.src,this.blendFunc.dst,this.blendFunc.srcAlpha,this.blendFunc.dstAlpha),this.gl.renderer.setBlendEquation(this.blendEquation.modeRGB,this.blendEquation.modeAlpha),this.stencilFunc.func||this.stencilOp.stencilFail?this.gl.renderer.enable(this.gl.STENCIL_TEST):this.gl.renderer.disable(this.gl.STENCIL_TEST),this.gl.renderer.setStencilFunc(this.stencilFunc.func,this.stencilFunc.ref,this.stencilFunc.mask),this.gl.renderer.setStencilOp(this.stencilOp.stencilFail,this.stencilOp.depthFail,this.stencilOp.depthPass)}use({flipFaces:e=!1}={}){let t=-1;this.gl.renderer.state.currentProgram!==this.id&&(this.gl.useProgram(this.program),this.gl.renderer.state.currentProgram=this.id),this.uniformLocations.forEach((e,n)=>{let r=this.uniforms[n.uniformName];for(let e of n.nameComponents){if(!r)break;if(e in r)r=r[e];else if(Array.isArray(r.value))break;else{r=void 0;break}}if(!r)return ru(`Active uniform ${n.name} has not been supplied`);if(r&&r.value===void 0)return ru(`${n.name} uniform is missing a value parameter`);if(r.value.texture)return t+=1,r.value.update(t),Zl(this.gl,n.type,e,t);if(r.value.length&&r.value[0].texture){let i=[];return r.value.forEach(e=>{t+=1,e.update(t),i.push(t)}),Zl(this.gl,n.type,e,i)}Zl(this.gl,n.type,e,r.value)}),this.applyState(),e&&this.gl.renderer.setFrontFace(this.frontFace===this.gl.CCW?this.gl.CW:this.gl.CCW)}remove(){this.gl.deleteProgram(this.program)}};function Zl(e,t,n,r){r=r.length?$l(r):r;let i=e.renderer.state.uniformLocations.get(n);if(r.length)if(i===void 0||i.length!==r.length)e.renderer.state.uniformLocations.set(n,r.slice(0));else{if(eu(i,r))return;i.set?i.set(r):tu(i,r),e.renderer.state.uniformLocations.set(n,i)}else{if(i===r)return;e.renderer.state.uniformLocations.set(n,r)}switch(t){case 5126:return r.length?e.uniform1fv(n,r):e.uniform1f(n,r);case 35664:return e.uniform2fv(n,r);case 35665:return e.uniform3fv(n,r);case 35666:return e.uniform4fv(n,r);case 35670:case 5124:case 35678:case 36306:case 35680:case 36289:return r.length?e.uniform1iv(n,r):e.uniform1i(n,r);case 35671:case 35667:return e.uniform2iv(n,r);case 35672:case 35668:return e.uniform3iv(n,r);case 35673:case 35669:return e.uniform4iv(n,r);case 35674:return e.uniformMatrix2fv(n,!1,r);case 35675:return e.uniformMatrix3fv(n,!1,r);case 35676:return e.uniformMatrix4fv(n,!1,r)}}function Ql(e){let t=e.split(`
`);for(let e=0;e<t.length;e++)t[e]=e+1+`: `+t[e];return t.join(`
`)}function $l(e){let t=e.length,n=e[0].length;if(n===void 0)return e;let r=t*n,i=Yl[r];i||(Yl[r]=i=new Float32Array(r));for(let r=0;r<t;r++)i.set(e[r],r*n);return i}function eu(e,t){if(e.length!==t.length)return!1;for(let n=0,r=e.length;n<r;n++)if(e[n]!==t[n])return!1;return!0}function tu(e,t){for(let n=0,r=e.length;n<r;n++)e[n]=t[n]}var nu=0;function ru(e){nu>100||(console.warn(e),nu++,nu>100&&console.warn(`More than 100 program warnings - stopping logs.`))}var iu=new Hl,au=1,ou=class{constructor({canvas:e=document.createElement(`canvas`),width:t=300,height:n=150,dpr:r=1,alpha:i=!1,depth:a=!0,stencil:o=!1,antialias:s=!1,premultipliedAlpha:c=!1,preserveDrawingBuffer:l=!1,powerPreference:u=`default`,autoClear:d=!0,webgl:f=2}={}){let p={alpha:i,depth:a,stencil:o,antialias:s,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u};this.dpr=r,this.alpha=i,this.color=!0,this.depth=a,this.stencil=o,this.premultipliedAlpha=c,this.autoClear=d,this.id=au++,f===2&&(this.gl=e.getContext(`webgl2`,p)),this.isWebgl2=!!this.gl,this.gl||=e.getContext(`webgl`,p),this.gl||console.error(`unable to create webgl context`),this.gl.renderer=this,this.setSize(t,n),this.state={},this.state.blendFunc={src:this.gl.ONE,dst:this.gl.ZERO},this.state.blendEquation={modeRGB:this.gl.FUNC_ADD},this.state.cullFace=!1,this.state.frontFace=this.gl.CCW,this.state.depthMask=!0,this.state.depthFunc=this.gl.LEQUAL,this.state.premultiplyAlpha=!1,this.state.flipY=!1,this.state.unpackAlignment=4,this.state.framebuffer=null,this.state.viewport={x:0,y:0,width:null,height:null},this.state.textureUnits=[],this.state.activeTextureUnit=0,this.state.boundBuffer=null,this.state.uniformLocations=new Map,this.state.currentProgram=null,this.extensions={},this.isWebgl2?(this.getExtension(`EXT_color_buffer_float`),this.getExtension(`OES_texture_float_linear`)):(this.getExtension(`OES_texture_float`),this.getExtension(`OES_texture_float_linear`),this.getExtension(`OES_texture_half_float`),this.getExtension(`OES_texture_half_float_linear`),this.getExtension(`OES_element_index_uint`),this.getExtension(`OES_standard_derivatives`),this.getExtension(`EXT_sRGB`),this.getExtension(`WEBGL_depth_texture`),this.getExtension(`WEBGL_draw_buffers`)),this.getExtension(`WEBGL_compressed_texture_astc`),this.getExtension(`EXT_texture_compression_bptc`),this.getExtension(`WEBGL_compressed_texture_s3tc`),this.getExtension(`WEBGL_compressed_texture_etc1`),this.getExtension(`WEBGL_compressed_texture_pvrtc`),this.getExtension(`WEBKIT_WEBGL_compressed_texture_pvrtc`),this.vertexAttribDivisor=this.getExtension(`ANGLE_instanced_arrays`,`vertexAttribDivisor`,`vertexAttribDivisorANGLE`),this.drawArraysInstanced=this.getExtension(`ANGLE_instanced_arrays`,`drawArraysInstanced`,`drawArraysInstancedANGLE`),this.drawElementsInstanced=this.getExtension(`ANGLE_instanced_arrays`,`drawElementsInstanced`,`drawElementsInstancedANGLE`),this.createVertexArray=this.getExtension(`OES_vertex_array_object`,`createVertexArray`,`createVertexArrayOES`),this.bindVertexArray=this.getExtension(`OES_vertex_array_object`,`bindVertexArray`,`bindVertexArrayOES`),this.deleteVertexArray=this.getExtension(`OES_vertex_array_object`,`deleteVertexArray`,`deleteVertexArrayOES`),this.drawBuffers=this.getExtension(`WEBGL_draw_buffers`,`drawBuffers`,`drawBuffersWEBGL`),this.parameters={},this.parameters.maxTextureUnits=this.gl.getParameter(this.gl.MAX_COMBINED_TEXTURE_IMAGE_UNITS),this.parameters.maxAnisotropy=this.getExtension(`EXT_texture_filter_anisotropic`)?this.gl.getParameter(this.getExtension(`EXT_texture_filter_anisotropic`).MAX_TEXTURE_MAX_ANISOTROPY_EXT):0}setSize(e,t){this.width=e,this.height=t,this.gl.canvas.width=e*this.dpr,this.gl.canvas.height=t*this.dpr,this.gl.canvas.style&&Object.assign(this.gl.canvas.style,{width:e+`px`,height:t+`px`})}setViewport(e,t,n=0,r=0){this.state.viewport.width===e&&this.state.viewport.height===t||(this.state.viewport.width=e,this.state.viewport.height=t,this.state.viewport.x=n,this.state.viewport.y=r,this.gl.viewport(n,r,e,t))}setScissor(e,t,n=0,r=0){this.gl.scissor(n,r,e,t)}enable(e){this.state[e]!==!0&&(this.gl.enable(e),this.state[e]=!0)}disable(e){this.state[e]!==!1&&(this.gl.disable(e),this.state[e]=!1)}setBlendFunc(e,t,n,r){this.state.blendFunc.src===e&&this.state.blendFunc.dst===t&&this.state.blendFunc.srcAlpha===n&&this.state.blendFunc.dstAlpha===r||(this.state.blendFunc.src=e,this.state.blendFunc.dst=t,this.state.blendFunc.srcAlpha=n,this.state.blendFunc.dstAlpha=r,n===void 0?this.gl.blendFunc(e,t):this.gl.blendFuncSeparate(e,t,n,r))}setBlendEquation(e,t){e||=this.gl.FUNC_ADD,!(this.state.blendEquation.modeRGB===e&&this.state.blendEquation.modeAlpha===t)&&(this.state.blendEquation.modeRGB=e,this.state.blendEquation.modeAlpha=t,t===void 0?this.gl.blendEquation(e):this.gl.blendEquationSeparate(e,t))}setCullFace(e){this.state.cullFace!==e&&(this.state.cullFace=e,this.gl.cullFace(e))}setFrontFace(e){this.state.frontFace!==e&&(this.state.frontFace=e,this.gl.frontFace(e))}setDepthMask(e){this.state.depthMask!==e&&(this.state.depthMask=e,this.gl.depthMask(e))}setDepthFunc(e){this.state.depthFunc!==e&&(this.state.depthFunc=e,this.gl.depthFunc(e))}setStencilMask(e){this.state.stencilMask!==e&&(this.state.stencilMask=e,this.gl.stencilMask(e))}setStencilFunc(e,t,n){this.state.stencilFunc===e&&this.state.stencilRef===t&&this.state.stencilFuncMask===n||(this.state.stencilFunc=e||this.gl.ALWAYS,this.state.stencilRef=t||0,this.state.stencilFuncMask=n||0,this.gl.stencilFunc(e||this.gl.ALWAYS,t||0,n||0))}setStencilOp(e,t,n){this.state.stencilFail===e&&this.state.stencilDepthFail===t&&this.state.stencilDepthPass===n||(this.state.stencilFail=e,this.state.stencilDepthFail=t,this.state.stencilDepthPass=n,this.gl.stencilOp(e,t,n))}activeTexture(e){this.state.activeTextureUnit!==e&&(this.state.activeTextureUnit=e,this.gl.activeTexture(this.gl.TEXTURE0+e))}bindFramebuffer({target:e=this.gl.FRAMEBUFFER,buffer:t=null}={}){this.state.framebuffer!==t&&(this.state.framebuffer=t,this.gl.bindFramebuffer(e,t))}getExtension(e,t,n){return t&&this.gl[t]?this.gl[t].bind(this.gl):(this.extensions[e]||(this.extensions[e]=this.gl.getExtension(e)),t?this.extensions[e]?this.extensions[e][n].bind(this.extensions[e]):null:this.extensions[e])}sortOpaque(e,t){return e.renderOrder===t.renderOrder?e.program.id===t.program.id?e.zDepth===t.zDepth?t.id-e.id:e.zDepth-t.zDepth:e.program.id-t.program.id:e.renderOrder-t.renderOrder}sortTransparent(e,t){return e.renderOrder===t.renderOrder?e.zDepth===t.zDepth?t.id-e.id:t.zDepth-e.zDepth:e.renderOrder-t.renderOrder}sortUI(e,t){return e.renderOrder===t.renderOrder?e.program.id===t.program.id?t.id-e.id:e.program.id-t.program.id:e.renderOrder-t.renderOrder}getRenderList({scene:e,camera:t,frustumCull:n,sort:r}){let i=[];if(t&&n&&t.updateFrustum(),e.traverse(e=>{if(!e.visible)return!0;e.draw&&(n&&e.frustumCulled&&t&&!t.frustumIntersectsMesh(e)||i.push(e))}),r){let e=[],n=[],r=[];i.forEach(i=>{i.program.transparent?i.program.depthTest?n.push(i):r.push(i):e.push(i),i.zDepth=0,!(i.renderOrder!==0||!i.program.depthTest||!t)&&(i.worldMatrix.getTranslation(iu),iu.applyMatrix4(t.projectionViewMatrix),i.zDepth=iu.z)}),e.sort(this.sortOpaque),n.sort(this.sortTransparent),r.sort(this.sortUI),i=e.concat(n,r)}return i}render({scene:e,camera:t,target:n=null,update:r=!0,sort:i=!0,frustumCull:a=!0,clear:o}){n===null?(this.bindFramebuffer(),this.setViewport(this.width*this.dpr,this.height*this.dpr)):(this.bindFramebuffer(n),this.setViewport(n.width,n.height)),(o||this.autoClear&&o!==!1)&&(this.depth&&(!n||n.depth)&&(this.enable(this.gl.DEPTH_TEST),this.setDepthMask(!0)),(this.stencil||!n||n.stencil)&&(this.enable(this.gl.STENCIL_TEST),this.setStencilMask(255)),this.gl.clear((this.color?this.gl.COLOR_BUFFER_BIT:0)|(this.depth?this.gl.DEPTH_BUFFER_BIT:0)|(this.stencil?this.gl.STENCIL_BUFFER_BIT:0))),r&&e.updateMatrixWorld(),t&&t.updateMatrixWorld(),this.getRenderList({scene:e,camera:t,frustumCull:a,sort:i}).forEach(e=>{e.draw({camera:t})})}};function su(e,t){return e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=t[3],e}function cu(e,t,n,r,i){return e[0]=t,e[1]=n,e[2]=r,e[3]=i,e}function lu(e,t){let n=t[0],r=t[1],i=t[2],a=t[3],o=n*n+r*r+i*i+a*a;return o>0&&(o=1/Math.sqrt(o)),e[0]=n*o,e[1]=r*o,e[2]=i*o,e[3]=a*o,e}function uu(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]+e[3]*t[3]}function du(e){return e[0]=0,e[1]=0,e[2]=0,e[3]=1,e}function fu(e,t,n){n*=.5;let r=Math.sin(n);return e[0]=r*t[0],e[1]=r*t[1],e[2]=r*t[2],e[3]=Math.cos(n),e}function pu(e,t,n){let r=t[0],i=t[1],a=t[2],o=t[3],s=n[0],c=n[1],l=n[2],u=n[3];return e[0]=r*u+o*s+i*l-a*c,e[1]=i*u+o*c+a*s-r*l,e[2]=a*u+o*l+r*c-i*s,e[3]=o*u-r*s-i*c-a*l,e}function mu(e,t,n){n*=.5;let r=t[0],i=t[1],a=t[2],o=t[3],s=Math.sin(n),c=Math.cos(n);return e[0]=r*c+o*s,e[1]=i*c+a*s,e[2]=a*c-i*s,e[3]=o*c-r*s,e}function hu(e,t,n){n*=.5;let r=t[0],i=t[1],a=t[2],o=t[3],s=Math.sin(n),c=Math.cos(n);return e[0]=r*c-a*s,e[1]=i*c+o*s,e[2]=a*c+r*s,e[3]=o*c-i*s,e}function gu(e,t,n){n*=.5;let r=t[0],i=t[1],a=t[2],o=t[3],s=Math.sin(n),c=Math.cos(n);return e[0]=r*c+i*s,e[1]=i*c-r*s,e[2]=a*c+o*s,e[3]=o*c-a*s,e}function _u(e,t,n,r){let i=t[0],a=t[1],o=t[2],s=t[3],c=n[0],l=n[1],u=n[2],d=n[3],f,p,m,h,g;return p=i*c+a*l+o*u+s*d,p<0&&(p=-p,c=-c,l=-l,u=-u,d=-d),1-p>1e-6?(f=Math.acos(p),m=Math.sin(f),h=Math.sin((1-r)*f)/m,g=Math.sin(r*f)/m):(h=1-r,g=r),e[0]=h*i+g*c,e[1]=h*a+g*l,e[2]=h*o+g*u,e[3]=h*s+g*d,e}function vu(e,t){let n=t[0],r=t[1],i=t[2],a=t[3],o=n*n+r*r+i*i+a*a,s=o?1/o:0;return e[0]=-n*s,e[1]=-r*s,e[2]=-i*s,e[3]=a*s,e}function yu(e,t){return e[0]=-t[0],e[1]=-t[1],e[2]=-t[2],e[3]=t[3],e}function bu(e,t){let n=t[0]+t[4]+t[8],r;if(n>0)r=Math.sqrt(n+1),e[3]=.5*r,r=.5/r,e[0]=(t[5]-t[7])*r,e[1]=(t[6]-t[2])*r,e[2]=(t[1]-t[3])*r;else{let n=0;t[4]>t[0]&&(n=1),t[8]>t[n*3+n]&&(n=2);let i=(n+1)%3,a=(n+2)%3;r=Math.sqrt(t[n*3+n]-t[i*3+i]-t[a*3+a]+1),e[n]=.5*r,r=.5/r,e[3]=(t[i*3+a]-t[a*3+i])*r,e[i]=(t[i*3+n]+t[n*3+i])*r,e[a]=(t[a*3+n]+t[n*3+a])*r}return e}function xu(e,t,n=`YXZ`){let r=Math.sin(t[0]*.5),i=Math.cos(t[0]*.5),a=Math.sin(t[1]*.5),o=Math.cos(t[1]*.5),s=Math.sin(t[2]*.5),c=Math.cos(t[2]*.5);return n===`XYZ`?(e[0]=r*o*c+i*a*s,e[1]=i*a*c-r*o*s,e[2]=i*o*s+r*a*c,e[3]=i*o*c-r*a*s):n===`YXZ`?(e[0]=r*o*c+i*a*s,e[1]=i*a*c-r*o*s,e[2]=i*o*s-r*a*c,e[3]=i*o*c+r*a*s):n===`ZXY`?(e[0]=r*o*c-i*a*s,e[1]=i*a*c+r*o*s,e[2]=i*o*s+r*a*c,e[3]=i*o*c-r*a*s):n===`ZYX`?(e[0]=r*o*c-i*a*s,e[1]=i*a*c+r*o*s,e[2]=i*o*s-r*a*c,e[3]=i*o*c+r*a*s):n===`YZX`?(e[0]=r*o*c+i*a*s,e[1]=i*a*c+r*o*s,e[2]=i*o*s-r*a*c,e[3]=i*o*c-r*a*s):n===`XZY`&&(e[0]=r*o*c-i*a*s,e[1]=i*a*c-r*o*s,e[2]=i*o*s+r*a*c,e[3]=i*o*c+r*a*s),e}var Su=su,Cu=cu,wu=uu,Tu=lu,Eu=class extends Array{constructor(e=0,t=0,n=0,r=1){super(e,t,n,r),this.onChange=()=>{},this._target=this;let i=[`0`,`1`,`2`,`3`];return new Proxy(this,{set(e,t){let n=Reflect.set(...arguments);return n&&i.includes(t)&&e.onChange(),n}})}get x(){return this[0]}get y(){return this[1]}get z(){return this[2]}get w(){return this[3]}set x(e){this._target[0]=e,this.onChange()}set y(e){this._target[1]=e,this.onChange()}set z(e){this._target[2]=e,this.onChange()}set w(e){this._target[3]=e,this.onChange()}identity(){return du(this._target),this.onChange(),this}set(e,t,n,r){return e.length?this.copy(e):(Cu(this._target,e,t,n,r),this.onChange(),this)}rotateX(e){return mu(this._target,this._target,e),this.onChange(),this}rotateY(e){return hu(this._target,this._target,e),this.onChange(),this}rotateZ(e){return gu(this._target,this._target,e),this.onChange(),this}inverse(e=this._target){return vu(this._target,e),this.onChange(),this}conjugate(e=this._target){return yu(this._target,e),this.onChange(),this}copy(e){return Su(this._target,e),this.onChange(),this}normalize(e=this._target){return Tu(this._target,e),this.onChange(),this}multiply(e,t){return t?pu(this._target,e,t):pu(this._target,this._target,e),this.onChange(),this}dot(e){return wu(this._target,e)}fromMatrix3(e){return bu(this._target,e),this.onChange(),this}fromEuler(e,t){return xu(this._target,e,e.order),t||this.onChange(),this}fromAxisAngle(e,t){return fu(this._target,e,t),this.onChange(),this}slerp(e,t){return _u(this._target,this._target,e,t),this.onChange(),this}fromArray(e,t=0){return this._target[0]=e[t],this._target[1]=e[t+1],this._target[2]=e[t+2],this._target[3]=e[t+3],this.onChange(),this}toArray(e=[],t=0){return e[t]=this[0],e[t+1]=this[1],e[t+2]=this[2],e[t+3]=this[3],e}},Du=1e-6;function Ou(e,t){return e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=t[3],e[4]=t[4],e[5]=t[5],e[6]=t[6],e[7]=t[7],e[8]=t[8],e[9]=t[9],e[10]=t[10],e[11]=t[11],e[12]=t[12],e[13]=t[13],e[14]=t[14],e[15]=t[15],e}function ku(e,t,n,r,i,a,o,s,c,l,u,d,f,p,m,h,g){return e[0]=t,e[1]=n,e[2]=r,e[3]=i,e[4]=a,e[5]=o,e[6]=s,e[7]=c,e[8]=l,e[9]=u,e[10]=d,e[11]=f,e[12]=p,e[13]=m,e[14]=h,e[15]=g,e}function Au(e){return e[0]=1,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=1,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=1,e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function ju(e,t){let n=t[0],r=t[1],i=t[2],a=t[3],o=t[4],s=t[5],c=t[6],l=t[7],u=t[8],d=t[9],f=t[10],p=t[11],m=t[12],h=t[13],g=t[14],_=t[15],v=n*s-r*o,y=n*c-i*o,b=n*l-a*o,x=r*c-i*s,S=r*l-a*s,C=i*l-a*c,w=u*h-d*m,T=u*g-f*m,E=u*_-p*m,D=d*g-f*h,O=d*_-p*h,k=f*_-p*g,A=v*k-y*O+b*D+x*E-S*T+C*w;return A?(A=1/A,e[0]=(s*k-c*O+l*D)*A,e[1]=(i*O-r*k-a*D)*A,e[2]=(h*C-g*S+_*x)*A,e[3]=(f*S-d*C-p*x)*A,e[4]=(c*E-o*k-l*T)*A,e[5]=(n*k-i*E+a*T)*A,e[6]=(g*b-m*C-_*y)*A,e[7]=(u*C-f*b+p*y)*A,e[8]=(o*O-s*E+l*w)*A,e[9]=(r*E-n*O-a*w)*A,e[10]=(m*S-h*b+_*v)*A,e[11]=(d*b-u*S-p*v)*A,e[12]=(s*T-o*D-c*w)*A,e[13]=(n*D-r*T+i*w)*A,e[14]=(h*y-m*x-g*v)*A,e[15]=(u*x-d*y+f*v)*A,e):null}function Mu(e){let t=e[0],n=e[1],r=e[2],i=e[3],a=e[4],o=e[5],s=e[6],c=e[7],l=e[8],u=e[9],d=e[10],f=e[11],p=e[12],m=e[13],h=e[14],g=e[15],_=t*o-n*a,v=t*s-r*a,y=t*c-i*a,b=n*s-r*o,x=n*c-i*o,S=r*c-i*s,C=l*m-u*p,w=l*h-d*p,T=l*g-f*p,E=u*h-d*m,D=u*g-f*m;return _*(d*g-f*h)-v*D+y*E+b*T-x*w+S*C}function Nu(e,t,n){let r=t[0],i=t[1],a=t[2],o=t[3],s=t[4],c=t[5],l=t[6],u=t[7],d=t[8],f=t[9],p=t[10],m=t[11],h=t[12],g=t[13],_=t[14],v=t[15],y=n[0],b=n[1],x=n[2],S=n[3];return e[0]=y*r+b*s+x*d+S*h,e[1]=y*i+b*c+x*f+S*g,e[2]=y*a+b*l+x*p+S*_,e[3]=y*o+b*u+x*m+S*v,y=n[4],b=n[5],x=n[6],S=n[7],e[4]=y*r+b*s+x*d+S*h,e[5]=y*i+b*c+x*f+S*g,e[6]=y*a+b*l+x*p+S*_,e[7]=y*o+b*u+x*m+S*v,y=n[8],b=n[9],x=n[10],S=n[11],e[8]=y*r+b*s+x*d+S*h,e[9]=y*i+b*c+x*f+S*g,e[10]=y*a+b*l+x*p+S*_,e[11]=y*o+b*u+x*m+S*v,y=n[12],b=n[13],x=n[14],S=n[15],e[12]=y*r+b*s+x*d+S*h,e[13]=y*i+b*c+x*f+S*g,e[14]=y*a+b*l+x*p+S*_,e[15]=y*o+b*u+x*m+S*v,e}function Pu(e,t,n){let r=n[0],i=n[1],a=n[2],o,s,c,l,u,d,f,p,m,h,g,_;return t===e?(e[12]=t[0]*r+t[4]*i+t[8]*a+t[12],e[13]=t[1]*r+t[5]*i+t[9]*a+t[13],e[14]=t[2]*r+t[6]*i+t[10]*a+t[14],e[15]=t[3]*r+t[7]*i+t[11]*a+t[15]):(o=t[0],s=t[1],c=t[2],l=t[3],u=t[4],d=t[5],f=t[6],p=t[7],m=t[8],h=t[9],g=t[10],_=t[11],e[0]=o,e[1]=s,e[2]=c,e[3]=l,e[4]=u,e[5]=d,e[6]=f,e[7]=p,e[8]=m,e[9]=h,e[10]=g,e[11]=_,e[12]=o*r+u*i+m*a+t[12],e[13]=s*r+d*i+h*a+t[13],e[14]=c*r+f*i+g*a+t[14],e[15]=l*r+p*i+_*a+t[15]),e}function Fu(e,t,n){let r=n[0],i=n[1],a=n[2];return e[0]=t[0]*r,e[1]=t[1]*r,e[2]=t[2]*r,e[3]=t[3]*r,e[4]=t[4]*i,e[5]=t[5]*i,e[6]=t[6]*i,e[7]=t[7]*i,e[8]=t[8]*a,e[9]=t[9]*a,e[10]=t[10]*a,e[11]=t[11]*a,e[12]=t[12],e[13]=t[13],e[14]=t[14],e[15]=t[15],e}function Iu(e,t,n,r){let i=r[0],a=r[1],o=r[2],s=Math.hypot(i,a,o),c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,ee;return Math.abs(s)<Du?null:(s=1/s,i*=s,a*=s,o*=s,c=Math.sin(n),l=Math.cos(n),u=1-l,d=t[0],f=t[1],p=t[2],m=t[3],h=t[4],g=t[5],_=t[6],v=t[7],y=t[8],b=t[9],x=t[10],S=t[11],C=i*i*u+l,w=a*i*u+o*c,T=o*i*u-a*c,E=i*a*u-o*c,D=a*a*u+l,O=o*a*u+i*c,k=i*o*u+a*c,A=a*o*u-i*c,ee=o*o*u+l,e[0]=d*C+h*w+y*T,e[1]=f*C+g*w+b*T,e[2]=p*C+_*w+x*T,e[3]=m*C+v*w+S*T,e[4]=d*E+h*D+y*O,e[5]=f*E+g*D+b*O,e[6]=p*E+_*D+x*O,e[7]=m*E+v*D+S*O,e[8]=d*k+h*A+y*ee,e[9]=f*k+g*A+b*ee,e[10]=p*k+_*A+x*ee,e[11]=m*k+v*A+S*ee,t!==e&&(e[12]=t[12],e[13]=t[13],e[14]=t[14],e[15]=t[15]),e)}function Lu(e,t){return e[0]=t[12],e[1]=t[13],e[2]=t[14],e}function Ru(e,t){let n=t[0],r=t[1],i=t[2],a=t[4],o=t[5],s=t[6],c=t[8],l=t[9],u=t[10];return e[0]=Math.hypot(n,r,i),e[1]=Math.hypot(a,o,s),e[2]=Math.hypot(c,l,u),e}function zu(e){let t=e[0],n=e[1],r=e[2],i=e[4],a=e[5],o=e[6],s=e[8],c=e[9],l=e[10],u=t*t+n*n+r*r,d=i*i+a*a+o*o,f=s*s+c*c+l*l;return Math.sqrt(Math.max(u,d,f))}var Bu=(function(){let e=[1,1,1];return function(t,n){let r=e;Ru(r,n);let i=1/r[0],a=1/r[1],o=1/r[2],s=n[0]*i,c=n[1]*a,l=n[2]*o,u=n[4]*i,d=n[5]*a,f=n[6]*o,p=n[8]*i,m=n[9]*a,h=n[10]*o,g=s+d+h,_=0;return g>0?(_=Math.sqrt(g+1)*2,t[3]=.25*_,t[0]=(f-m)/_,t[1]=(p-l)/_,t[2]=(c-u)/_):s>d&&s>h?(_=Math.sqrt(1+s-d-h)*2,t[3]=(f-m)/_,t[0]=.25*_,t[1]=(c+u)/_,t[2]=(p+l)/_):d>h?(_=Math.sqrt(1+d-s-h)*2,t[3]=(p-l)/_,t[0]=(c+u)/_,t[1]=.25*_,t[2]=(f+m)/_):(_=Math.sqrt(1+h-s-d)*2,t[3]=(c-u)/_,t[0]=(p+l)/_,t[1]=(f+m)/_,t[2]=.25*_),t}})();function Vu(e,t,n,r){let i=yl([e[0],e[1],e[2]]),a=yl([e[4],e[5],e[6]]),o=yl([e[8],e[9],e[10]]);Mu(e)<0&&(i=-i),n[0]=e[12],n[1]=e[13],n[2]=e[14];let s=e.slice(),c=1/i,l=1/a,u=1/o;s[0]*=c,s[1]*=c,s[2]*=c,s[4]*=l,s[5]*=l,s[6]*=l,s[8]*=u,s[9]*=u,s[10]*=u,Bu(t,s),r[0]=i,r[1]=a,r[2]=o}function Hu(e,t,n,r){let i=e,a=t[0],o=t[1],s=t[2],c=t[3],l=a+a,u=o+o,d=s+s,f=a*l,p=a*u,m=a*d,h=o*u,g=o*d,_=s*d,v=c*l,y=c*u,b=c*d,x=r[0],S=r[1],C=r[2];return i[0]=(1-(h+_))*x,i[1]=(p+b)*x,i[2]=(m-y)*x,i[3]=0,i[4]=(p-b)*S,i[5]=(1-(f+_))*S,i[6]=(g+v)*S,i[7]=0,i[8]=(m+y)*C,i[9]=(g-v)*C,i[10]=(1-(f+h))*C,i[11]=0,i[12]=n[0],i[13]=n[1],i[14]=n[2],i[15]=1,i}function Uu(e,t){let n=t[0],r=t[1],i=t[2],a=t[3],o=n+n,s=r+r,c=i+i,l=n*o,u=r*o,d=r*s,f=i*o,p=i*s,m=i*c,h=a*o,g=a*s,_=a*c;return e[0]=1-d-m,e[1]=u+_,e[2]=f-g,e[3]=0,e[4]=u-_,e[5]=1-l-m,e[6]=p+h,e[7]=0,e[8]=f+g,e[9]=p-h,e[10]=1-l-d,e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function Wu(e,t,n,r,i){let a=1/Math.tan(t/2),o=1/(r-i);return e[0]=a/n,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=a,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=(i+r)*o,e[11]=-1,e[12]=0,e[13]=0,e[14]=2*i*r*o,e[15]=0,e}function Gu(e,t,n,r,i,a,o){let s=1/(t-n),c=1/(r-i),l=1/(a-o);return e[0]=-2*s,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=-2*c,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=2*l,e[11]=0,e[12]=(t+n)*s,e[13]=(i+r)*c,e[14]=(o+a)*l,e[15]=1,e}function Ku(e,t,n,r){let i=t[0],a=t[1],o=t[2],s=r[0],c=r[1],l=r[2],u=i-n[0],d=a-n[1],f=o-n[2],p=u*u+d*d+f*f;p===0?f=1:(p=1/Math.sqrt(p),u*=p,d*=p,f*=p);let m=c*f-l*d,h=l*u-s*f,g=s*d-c*u;return p=m*m+h*h+g*g,p===0&&(l?s+=1e-6:c?l+=1e-6:c+=1e-6,m=c*f-l*d,h=l*u-s*f,g=s*d-c*u,p=m*m+h*h+g*g),p=1/Math.sqrt(p),m*=p,h*=p,g*=p,e[0]=m,e[1]=h,e[2]=g,e[3]=0,e[4]=d*g-f*h,e[5]=f*m-u*g,e[6]=u*h-d*m,e[7]=0,e[8]=u,e[9]=d,e[10]=f,e[11]=0,e[12]=i,e[13]=a,e[14]=o,e[15]=1,e}function qu(e,t,n){return e[0]=t[0]+n[0],e[1]=t[1]+n[1],e[2]=t[2]+n[2],e[3]=t[3]+n[3],e[4]=t[4]+n[4],e[5]=t[5]+n[5],e[6]=t[6]+n[6],e[7]=t[7]+n[7],e[8]=t[8]+n[8],e[9]=t[9]+n[9],e[10]=t[10]+n[10],e[11]=t[11]+n[11],e[12]=t[12]+n[12],e[13]=t[13]+n[13],e[14]=t[14]+n[14],e[15]=t[15]+n[15],e}function Ju(e,t,n){return e[0]=t[0]-n[0],e[1]=t[1]-n[1],e[2]=t[2]-n[2],e[3]=t[3]-n[3],e[4]=t[4]-n[4],e[5]=t[5]-n[5],e[6]=t[6]-n[6],e[7]=t[7]-n[7],e[8]=t[8]-n[8],e[9]=t[9]-n[9],e[10]=t[10]-n[10],e[11]=t[11]-n[11],e[12]=t[12]-n[12],e[13]=t[13]-n[13],e[14]=t[14]-n[14],e[15]=t[15]-n[15],e}function Yu(e,t,n){return e[0]=t[0]*n,e[1]=t[1]*n,e[2]=t[2]*n,e[3]=t[3]*n,e[4]=t[4]*n,e[5]=t[5]*n,e[6]=t[6]*n,e[7]=t[7]*n,e[8]=t[8]*n,e[9]=t[9]*n,e[10]=t[10]*n,e[11]=t[11]*n,e[12]=t[12]*n,e[13]=t[13]*n,e[14]=t[14]*n,e[15]=t[15]*n,e}var Xu=class extends Array{constructor(e=1,t=0,n=0,r=0,i=0,a=1,o=0,s=0,c=0,l=0,u=1,d=0,f=0,p=0,m=0,h=1){return super(e,t,n,r,i,a,o,s,c,l,u,d,f,p,m,h),this}get x(){return this[12]}get y(){return this[13]}get z(){return this[14]}get w(){return this[15]}set x(e){this[12]=e}set y(e){this[13]=e}set z(e){this[14]=e}set w(e){this[15]=e}set(e,t,n,r,i,a,o,s,c,l,u,d,f,p,m,h){return e.length?this.copy(e):(ku(this,e,t,n,r,i,a,o,s,c,l,u,d,f,p,m,h),this)}translate(e,t=this){return Pu(this,t,e),this}rotate(e,t,n=this){return Iu(this,n,e,t),this}scale(e,t=this){return Fu(this,t,typeof e==`number`?[e,e,e]:e),this}add(e,t){return t?qu(this,e,t):qu(this,this,e),this}sub(e,t){return t?Ju(this,e,t):Ju(this,this,e),this}multiply(e,t){return e.length?t?Nu(this,e,t):Nu(this,this,e):Yu(this,this,e),this}identity(){return Au(this),this}copy(e){return Ou(this,e),this}fromPerspective({fov:e,aspect:t,near:n,far:r}={}){return Wu(this,e,t,n,r),this}fromOrthogonal({left:e,right:t,bottom:n,top:r,near:i,far:a}){return Gu(this,e,t,n,r,i,a),this}fromQuaternion(e){return Uu(this,e),this}setPosition(e){return this.x=e[0],this.y=e[1],this.z=e[2],this}inverse(e=this){return ju(this,e),this}compose(e,t,n){return Hu(this,e,t,n),this}decompose(e,t,n){return Vu(this,e,t,n),this}getRotation(e){return Bu(e,this),this}getTranslation(e){return Lu(e,this),this}getScaling(e){return Ru(e,this),this}getMaxScaleOnAxis(){return zu(this)}lookAt(e,t,n){return Ku(this,e,t,n),this}determinant(){return Mu(this)}fromArray(e,t=0){return this[0]=e[t],this[1]=e[t+1],this[2]=e[t+2],this[3]=e[t+3],this[4]=e[t+4],this[5]=e[t+5],this[6]=e[t+6],this[7]=e[t+7],this[8]=e[t+8],this[9]=e[t+9],this[10]=e[t+10],this[11]=e[t+11],this[12]=e[t+12],this[13]=e[t+13],this[14]=e[t+14],this[15]=e[t+15],this}toArray(e=[],t=0){return e[t]=this[0],e[t+1]=this[1],e[t+2]=this[2],e[t+3]=this[3],e[t+4]=this[4],e[t+5]=this[5],e[t+6]=this[6],e[t+7]=this[7],e[t+8]=this[8],e[t+9]=this[9],e[t+10]=this[10],e[t+11]=this[11],e[t+12]=this[12],e[t+13]=this[13],e[t+14]=this[14],e[t+15]=this[15],e}};function Zu(e,t,n=`YXZ`){return n===`XYZ`?(e[1]=Math.asin(Math.min(Math.max(t[8],-1),1)),Math.abs(t[8])<.99999?(e[0]=Math.atan2(-t[9],t[10]),e[2]=Math.atan2(-t[4],t[0])):(e[0]=Math.atan2(t[6],t[5]),e[2]=0)):n===`YXZ`?(e[0]=Math.asin(-Math.min(Math.max(t[9],-1),1)),Math.abs(t[9])<.99999?(e[1]=Math.atan2(t[8],t[10]),e[2]=Math.atan2(t[1],t[5])):(e[1]=Math.atan2(-t[2],t[0]),e[2]=0)):n===`ZXY`?(e[0]=Math.asin(Math.min(Math.max(t[6],-1),1)),Math.abs(t[6])<.99999?(e[1]=Math.atan2(-t[2],t[10]),e[2]=Math.atan2(-t[4],t[5])):(e[1]=0,e[2]=Math.atan2(t[1],t[0]))):n===`ZYX`?(e[1]=Math.asin(-Math.min(Math.max(t[2],-1),1)),Math.abs(t[2])<.99999?(e[0]=Math.atan2(t[6],t[10]),e[2]=Math.atan2(t[1],t[0])):(e[0]=0,e[2]=Math.atan2(-t[4],t[5]))):n===`YZX`?(e[2]=Math.asin(Math.min(Math.max(t[1],-1),1)),Math.abs(t[1])<.99999?(e[0]=Math.atan2(-t[9],t[5]),e[1]=Math.atan2(-t[2],t[0])):(e[0]=0,e[1]=Math.atan2(t[8],t[10]))):n===`XZY`&&(e[2]=Math.asin(-Math.min(Math.max(t[4],-1),1)),Math.abs(t[4])<.99999?(e[0]=Math.atan2(t[6],t[5]),e[1]=Math.atan2(t[8],t[0])):(e[0]=Math.atan2(-t[9],t[10]),e[1]=0)),e}var Qu=new Xu,$u=class extends Array{constructor(e=0,t=e,n=e,r=`YXZ`){super(e,t,n),this.order=r,this.onChange=()=>{},this._target=this;let i=[`0`,`1`,`2`];return new Proxy(this,{set(e,t){let n=Reflect.set(...arguments);return n&&i.includes(t)&&e.onChange(),n}})}get x(){return this[0]}get y(){return this[1]}get z(){return this[2]}set x(e){this._target[0]=e,this.onChange()}set y(e){this._target[1]=e,this.onChange()}set z(e){this._target[2]=e,this.onChange()}set(e,t=e,n=e){return e.length?this.copy(e):(this._target[0]=e,this._target[1]=t,this._target[2]=n,this.onChange(),this)}copy(e){return this._target[0]=e[0],this._target[1]=e[1],this._target[2]=e[2],this.onChange(),this}reorder(e){return this._target.order=e,this.onChange(),this}fromRotationMatrix(e,t=this.order){return Zu(this._target,e,t),this.onChange(),this}fromQuaternion(e,t=this.order,n){return Qu.fromQuaternion(e),this._target.fromRotationMatrix(Qu,t),n||this.onChange(),this}fromArray(e,t=0){return this._target[0]=e[t],this._target[1]=e[t+1],this._target[2]=e[t+2],this}toArray(e=[],t=0){return e[t]=this[0],e[t+1]=this[1],e[t+2]=this[2],e}},ed=class{constructor(){this.parent=null,this.children=[],this.visible=!0,this.matrix=new Xu,this.worldMatrix=new Xu,this.matrixAutoUpdate=!0,this.worldMatrixNeedsUpdate=!1,this.position=new Hl,this.quaternion=new Eu,this.scale=new Hl(1),this.rotation=new $u,this.up=new Hl(0,1,0),this.rotation._target.onChange=()=>this.quaternion.fromEuler(this.rotation,!0),this.quaternion._target.onChange=()=>this.rotation.fromQuaternion(this.quaternion,void 0,!0)}setParent(e,t=!0){this.parent&&e!==this.parent&&this.parent.removeChild(this,!1),this.parent=e,t&&e&&e.addChild(this,!1)}addChild(e,t=!0){~this.children.indexOf(e)||this.children.push(e),t&&e.setParent(this,!1)}removeChild(e,t=!0){~this.children.indexOf(e)&&this.children.splice(this.children.indexOf(e),1),t&&e.setParent(null,!1)}updateMatrixWorld(e){this.matrixAutoUpdate&&this.updateMatrix(),(this.worldMatrixNeedsUpdate||e)&&(this.parent===null?this.worldMatrix.copy(this.matrix):this.worldMatrix.multiply(this.parent.worldMatrix,this.matrix),this.worldMatrixNeedsUpdate=!1,e=!0);for(let t=0,n=this.children.length;t<n;t++)this.children[t].updateMatrixWorld(e)}updateMatrix(){this.matrix.compose(this.quaternion,this.position,this.scale),this.worldMatrixNeedsUpdate=!0}traverse(e){if(!e(this))for(let t=0,n=this.children.length;t<n;t++)this.children[t].traverse(e)}decompose(){this.matrix.decompose(this.quaternion._target,this.position,this.scale),this.rotation.fromQuaternion(this.quaternion)}lookAt(e,t=!1){t?this.matrix.lookAt(this.position,e,this.up):this.matrix.lookAt(e,this.position,this.up),this.matrix.getRotation(this.quaternion._target),this.rotation.fromQuaternion(this.quaternion)}};function td(e,t){return e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=t[4],e[4]=t[5],e[5]=t[6],e[6]=t[8],e[7]=t[9],e[8]=t[10],e}function nd(e,t){let n=t[0],r=t[1],i=t[2],a=t[3],o=n+n,s=r+r,c=i+i,l=n*o,u=r*o,d=r*s,f=i*o,p=i*s,m=i*c,h=a*o,g=a*s,_=a*c;return e[0]=1-d-m,e[3]=u-_,e[6]=f+g,e[1]=u+_,e[4]=1-l-m,e[7]=p-h,e[2]=f-g,e[5]=p+h,e[8]=1-l-d,e}function rd(e,t){return e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=t[3],e[4]=t[4],e[5]=t[5],e[6]=t[6],e[7]=t[7],e[8]=t[8],e}function id(e,t,n,r,i,a,o,s,c,l){return e[0]=t,e[1]=n,e[2]=r,e[3]=i,e[4]=a,e[5]=o,e[6]=s,e[7]=c,e[8]=l,e}function ad(e){return e[0]=1,e[1]=0,e[2]=0,e[3]=0,e[4]=1,e[5]=0,e[6]=0,e[7]=0,e[8]=1,e}function od(e,t){let n=t[0],r=t[1],i=t[2],a=t[3],o=t[4],s=t[5],c=t[6],l=t[7],u=t[8],d=u*o-s*l,f=-u*a+s*c,p=l*a-o*c,m=n*d+r*f+i*p;return m?(m=1/m,e[0]=d*m,e[1]=(-u*r+i*l)*m,e[2]=(s*r-i*o)*m,e[3]=f*m,e[4]=(u*n-i*c)*m,e[5]=(-s*n+i*a)*m,e[6]=p*m,e[7]=(-l*n+r*c)*m,e[8]=(o*n-r*a)*m,e):null}function sd(e,t,n){let r=t[0],i=t[1],a=t[2],o=t[3],s=t[4],c=t[5],l=t[6],u=t[7],d=t[8],f=n[0],p=n[1],m=n[2],h=n[3],g=n[4],_=n[5],v=n[6],y=n[7],b=n[8];return e[0]=f*r+p*o+m*l,e[1]=f*i+p*s+m*u,e[2]=f*a+p*c+m*d,e[3]=h*r+g*o+_*l,e[4]=h*i+g*s+_*u,e[5]=h*a+g*c+_*d,e[6]=v*r+y*o+b*l,e[7]=v*i+y*s+b*u,e[8]=v*a+y*c+b*d,e}function cd(e,t,n){let r=t[0],i=t[1],a=t[2],o=t[3],s=t[4],c=t[5],l=t[6],u=t[7],d=t[8],f=n[0],p=n[1];return e[0]=r,e[1]=i,e[2]=a,e[3]=o,e[4]=s,e[5]=c,e[6]=f*r+p*o+l,e[7]=f*i+p*s+u,e[8]=f*a+p*c+d,e}function ld(e,t,n){let r=t[0],i=t[1],a=t[2],o=t[3],s=t[4],c=t[5],l=t[6],u=t[7],d=t[8],f=Math.sin(n),p=Math.cos(n);return e[0]=p*r+f*o,e[1]=p*i+f*s,e[2]=p*a+f*c,e[3]=p*o-f*r,e[4]=p*s-f*i,e[5]=p*c-f*a,e[6]=l,e[7]=u,e[8]=d,e}function ud(e,t,n){let r=n[0],i=n[1];return e[0]=r*t[0],e[1]=r*t[1],e[2]=r*t[2],e[3]=i*t[3],e[4]=i*t[4],e[5]=i*t[5],e[6]=t[6],e[7]=t[7],e[8]=t[8],e}function dd(e,t){let n=t[0],r=t[1],i=t[2],a=t[3],o=t[4],s=t[5],c=t[6],l=t[7],u=t[8],d=t[9],f=t[10],p=t[11],m=t[12],h=t[13],g=t[14],_=t[15],v=n*s-r*o,y=n*c-i*o,b=n*l-a*o,x=r*c-i*s,S=r*l-a*s,C=i*l-a*c,w=u*h-d*m,T=u*g-f*m,E=u*_-p*m,D=d*g-f*h,O=d*_-p*h,k=f*_-p*g,A=v*k-y*O+b*D+x*E-S*T+C*w;return A?(A=1/A,e[0]=(s*k-c*O+l*D)*A,e[1]=(c*E-o*k-l*T)*A,e[2]=(o*O-s*E+l*w)*A,e[3]=(i*O-r*k-a*D)*A,e[4]=(n*k-i*E+a*T)*A,e[5]=(r*E-n*O-a*w)*A,e[6]=(h*C-g*S+_*x)*A,e[7]=(g*b-m*C-_*y)*A,e[8]=(m*S-h*b+_*v)*A,e):null}var fd=class extends Array{constructor(e=1,t=0,n=0,r=0,i=1,a=0,o=0,s=0,c=1){return super(e,t,n,r,i,a,o,s,c),this}set(e,t,n,r,i,a,o,s,c){return e.length?this.copy(e):(id(this,e,t,n,r,i,a,o,s,c),this)}translate(e,t=this){return cd(this,t,e),this}rotate(e,t=this){return ld(this,t,e),this}scale(e,t=this){return ud(this,t,e),this}multiply(e,t){return t?sd(this,e,t):sd(this,this,e),this}identity(){return ad(this),this}copy(e){return rd(this,e),this}fromMatrix4(e){return td(this,e),this}fromQuaternion(e){return nd(this,e),this}fromBasis(e,t,n){return this.set(e[0],e[1],e[2],t[0],t[1],t[2],n[0],n[1],n[2]),this}inverse(e=this){return od(this,e),this}getNormalMatrix(e){return dd(this,e),this}},pd=0,md=class extends ed{constructor(e,{geometry:t,program:n,mode:r=e.TRIANGLES,frustumCulled:i=!0,renderOrder:a=0}={}){super(),e.canvas||console.error(`gl not passed as first argument to Mesh`),this.gl=e,this.id=pd++,this.geometry=t,this.program=n,this.mode=r,this.frustumCulled=i,this.renderOrder=a,this.modelViewMatrix=new Xu,this.normalMatrix=new fd,this.beforeRenderCallbacks=[],this.afterRenderCallbacks=[]}onBeforeRender(e){return this.beforeRenderCallbacks.push(e),this}onAfterRender(e){return this.afterRenderCallbacks.push(e),this}draw({camera:e}={}){e&&(this.program.uniforms.modelMatrix||Object.assign(this.program.uniforms,{modelMatrix:{value:null},viewMatrix:{value:null},modelViewMatrix:{value:null},normalMatrix:{value:null},projectionMatrix:{value:null},cameraPosition:{value:null}}),this.program.uniforms.projectionMatrix.value=e.projectionMatrix,this.program.uniforms.cameraPosition.value=e.worldPosition,this.program.uniforms.viewMatrix.value=e.viewMatrix,this.modelViewMatrix.multiply(e.viewMatrix,this.worldMatrix),this.normalMatrix.getNormalMatrix(this.modelViewMatrix),this.program.uniforms.modelMatrix.value=this.worldMatrix,this.program.uniforms.modelViewMatrix.value=this.modelViewMatrix,this.program.uniforms.normalMatrix.value=this.normalMatrix),this.beforeRenderCallbacks.forEach(t=>t&&t({mesh:this,camera:e}));let t=this.program.cullFace&&this.worldMatrix.determinant()<0;this.program.use({flipFaces:t}),this.geometry.draw({mode:this.mode,program:this.program}),this.afterRenderCallbacks.forEach(t=>t&&t({mesh:this,camera:e}))}},hd=new Uint8Array(4);function gd(e){return(e&e-1)==0}var _d=1,vd=class{constructor(e,{image:t,target:n=e.TEXTURE_2D,type:r=e.UNSIGNED_BYTE,format:i=e.RGBA,internalFormat:a=i,wrapS:o=e.CLAMP_TO_EDGE,wrapT:s=e.CLAMP_TO_EDGE,wrapR:c=e.CLAMP_TO_EDGE,generateMipmaps:l=n===(e.TEXTURE_2D||e.TEXTURE_CUBE_MAP),minFilter:u=l?e.NEAREST_MIPMAP_LINEAR:e.LINEAR,magFilter:d=e.LINEAR,premultiplyAlpha:f=!1,unpackAlignment:p=4,flipY:m=n==(e.TEXTURE_2D||e.TEXTURE_3D),anisotropy:h=0,level:g=0,width:_,height:v=_,length:y=1}={}){this.gl=e,this.id=_d++,this.image=t,this.target=n,this.type=r,this.format=i,this.internalFormat=a,this.minFilter=u,this.magFilter=d,this.wrapS=o,this.wrapT=s,this.wrapR=c,this.generateMipmaps=l,this.premultiplyAlpha=f,this.unpackAlignment=p,this.flipY=m,this.anisotropy=Math.min(h,this.gl.renderer.parameters.maxAnisotropy),this.level=g,this.width=_,this.height=v,this.length=y,this.texture=this.gl.createTexture(),this.store={image:null},this.glState=this.gl.renderer.state,this.state={},this.state.minFilter=this.gl.NEAREST_MIPMAP_LINEAR,this.state.magFilter=this.gl.LINEAR,this.state.wrapS=this.gl.REPEAT,this.state.wrapT=this.gl.REPEAT,this.state.anisotropy=0}bind(){this.glState.textureUnits[this.glState.activeTextureUnit]!==this.id&&(this.gl.bindTexture(this.target,this.texture),this.glState.textureUnits[this.glState.activeTextureUnit]=this.id)}update(e=0){let t=!(this.image===this.store.image&&!this.needsUpdate);if((t||this.glState.textureUnits[e]!==this.id)&&(this.gl.renderer.activeTexture(e),this.bind()),t){if(this.needsUpdate=!1,this.flipY!==this.glState.flipY&&(this.gl.pixelStorei(this.gl.UNPACK_FLIP_Y_WEBGL,this.flipY),this.glState.flipY=this.flipY),this.premultiplyAlpha!==this.glState.premultiplyAlpha&&(this.gl.pixelStorei(this.gl.UNPACK_PREMULTIPLY_ALPHA_WEBGL,this.premultiplyAlpha),this.glState.premultiplyAlpha=this.premultiplyAlpha),this.unpackAlignment!==this.glState.unpackAlignment&&(this.gl.pixelStorei(this.gl.UNPACK_ALIGNMENT,this.unpackAlignment),this.glState.unpackAlignment=this.unpackAlignment),this.minFilter!==this.state.minFilter&&(this.gl.texParameteri(this.target,this.gl.TEXTURE_MIN_FILTER,this.minFilter),this.state.minFilter=this.minFilter),this.magFilter!==this.state.magFilter&&(this.gl.texParameteri(this.target,this.gl.TEXTURE_MAG_FILTER,this.magFilter),this.state.magFilter=this.magFilter),this.wrapS!==this.state.wrapS&&(this.gl.texParameteri(this.target,this.gl.TEXTURE_WRAP_S,this.wrapS),this.state.wrapS=this.wrapS),this.wrapT!==this.state.wrapT&&(this.gl.texParameteri(this.target,this.gl.TEXTURE_WRAP_T,this.wrapT),this.state.wrapT=this.wrapT),this.wrapR!==this.state.wrapR&&(this.gl.texParameteri(this.target,this.gl.TEXTURE_WRAP_R,this.wrapR),this.state.wrapR=this.wrapR),this.anisotropy&&this.anisotropy!==this.state.anisotropy&&(this.gl.texParameterf(this.target,this.gl.renderer.getExtension(`EXT_texture_filter_anisotropic`).TEXTURE_MAX_ANISOTROPY_EXT,this.anisotropy),this.state.anisotropy=this.anisotropy),this.image){if(this.image.width&&(this.width=this.image.width,this.height=this.image.height),this.target===this.gl.TEXTURE_CUBE_MAP)for(let e=0;e<6;e++)this.gl.texImage2D(this.gl.TEXTURE_CUBE_MAP_POSITIVE_X+e,this.level,this.internalFormat,this.format,this.type,this.image[e]);else if(ArrayBuffer.isView(this.image))this.target===this.gl.TEXTURE_2D?this.gl.texImage2D(this.target,this.level,this.internalFormat,this.width,this.height,0,this.format,this.type,this.image):(this.target===this.gl.TEXTURE_2D_ARRAY||this.target===this.gl.TEXTURE_3D)&&this.gl.texImage3D(this.target,this.level,this.internalFormat,this.width,this.height,this.length,0,this.format,this.type,this.image);else if(this.image.isCompressedTexture)for(let e=0;e<this.image.length;e++)this.gl.compressedTexImage2D(this.target,e,this.internalFormat,this.image[e].width,this.image[e].height,0,this.image[e].data);else this.target===this.gl.TEXTURE_2D?this.gl.texImage2D(this.target,this.level,this.internalFormat,this.format,this.type,this.image):this.gl.texImage3D(this.target,this.level,this.internalFormat,this.width,this.height,this.length,0,this.format,this.type,this.image);this.generateMipmaps&&(!this.gl.renderer.isWebgl2&&(!gd(this.image.width)||!gd(this.image.height))?(this.generateMipmaps=!1,this.wrapS=this.wrapT=this.gl.CLAMP_TO_EDGE,this.minFilter=this.gl.LINEAR):this.gl.generateMipmap(this.target)),this.onUpdate&&this.onUpdate()}else if(this.target===this.gl.TEXTURE_CUBE_MAP)for(let e=0;e<6;e++)this.gl.texImage2D(this.gl.TEXTURE_CUBE_MAP_POSITIVE_X+e,0,this.gl.RGBA,1,1,0,this.gl.RGBA,this.gl.UNSIGNED_BYTE,hd);else this.width?this.target===this.gl.TEXTURE_2D?this.gl.texImage2D(this.target,this.level,this.internalFormat,this.width,this.height,0,this.format,this.type,null):this.gl.texImage3D(this.target,this.level,this.internalFormat,this.width,this.height,this.length,0,this.format,this.type,null):this.gl.texImage2D(this.target,0,this.gl.RGBA,1,1,0,this.gl.RGBA,this.gl.UNSIGNED_BYTE,hd);this.store.image=this.image}}},$=class{constructor(e,{width:t=e.canvas.width,height:n=e.canvas.height,target:r=e.FRAMEBUFFER,color:i=1,depth:a=!0,stencil:o=!1,depthTexture:s=!1,wrapS:c=e.CLAMP_TO_EDGE,wrapT:l=e.CLAMP_TO_EDGE,wrapR:u=e.CLAMP_TO_EDGE,minFilter:d=e.LINEAR,magFilter:f=d,type:p=e.UNSIGNED_BYTE,format:m=e.RGBA,internalFormat:h=m,unpackAlignment:g,premultiplyAlpha:_}={}){this.gl=e,this.width=t,this.height=n,this.depth=a,this.stencil=o,this.buffer=this.gl.createFramebuffer(),this.target=r,this.gl.renderer.bindFramebuffer(this),this.textures=[];let v=[];for(let r=0;r<i;r++)this.textures.push(new vd(e,{width:t,height:n,wrapS:c,wrapT:l,wrapR:u,minFilter:d,magFilter:f,type:p,format:m,internalFormat:h,unpackAlignment:g,premultiplyAlpha:_,flipY:!1,generateMipmaps:!1})),this.textures[r].update(),this.gl.framebufferTexture2D(this.target,this.gl.COLOR_ATTACHMENT0+r,this.gl.TEXTURE_2D,this.textures[r].texture,0),v.push(this.gl.COLOR_ATTACHMENT0+r);v.length>1&&this.gl.renderer.drawBuffers(v),this.texture=this.textures[0],s&&(this.gl.renderer.isWebgl2||this.gl.renderer.getExtension(`WEBGL_depth_texture`))?(this.depthTexture=new vd(e,{width:t,height:n,minFilter:this.gl.NEAREST,magFilter:this.gl.NEAREST,format:this.stencil?this.gl.DEPTH_STENCIL:this.gl.DEPTH_COMPONENT,internalFormat:e.renderer.isWebgl2?this.stencil?this.gl.DEPTH24_STENCIL8:this.gl.DEPTH_COMPONENT16:this.gl.DEPTH_COMPONENT,type:this.stencil?this.gl.UNSIGNED_INT_24_8:this.gl.UNSIGNED_INT}),this.depthTexture.update(),this.gl.framebufferTexture2D(this.target,this.stencil?this.gl.DEPTH_STENCIL_ATTACHMENT:this.gl.DEPTH_ATTACHMENT,this.gl.TEXTURE_2D,this.depthTexture.texture,0)):(a&&!o&&(this.depthBuffer=this.gl.createRenderbuffer(),this.gl.bindRenderbuffer(this.gl.RENDERBUFFER,this.depthBuffer),this.gl.renderbufferStorage(this.gl.RENDERBUFFER,this.gl.DEPTH_COMPONENT16,t,n),this.gl.framebufferRenderbuffer(this.target,this.gl.DEPTH_ATTACHMENT,this.gl.RENDERBUFFER,this.depthBuffer)),o&&!a&&(this.stencilBuffer=this.gl.createRenderbuffer(),this.gl.bindRenderbuffer(this.gl.RENDERBUFFER,this.stencilBuffer),this.gl.renderbufferStorage(this.gl.RENDERBUFFER,this.gl.STENCIL_INDEX8,t,n),this.gl.framebufferRenderbuffer(this.target,this.gl.STENCIL_ATTACHMENT,this.gl.RENDERBUFFER,this.stencilBuffer)),a&&o&&(this.depthStencilBuffer=this.gl.createRenderbuffer(),this.gl.bindRenderbuffer(this.gl.RENDERBUFFER,this.depthStencilBuffer),this.gl.renderbufferStorage(this.gl.RENDERBUFFER,this.gl.DEPTH_STENCIL,t,n),this.gl.framebufferRenderbuffer(this.target,this.gl.DEPTH_STENCIL_ATTACHMENT,this.gl.RENDERBUFFER,this.depthStencilBuffer))),this.gl.renderer.bindFramebuffer({target:this.target})}setSize(e,t){if(!(this.width===e&&this.height===t)){this.width=e,this.height=t,this.gl.renderer.bindFramebuffer(this);for(let n=0;n<this.textures.length;n++)this.textures[n].width=e,this.textures[n].height=t,this.textures[n].needsUpdate=!0,this.textures[n].update(),this.gl.framebufferTexture2D(this.target,this.gl.COLOR_ATTACHMENT0+n,this.gl.TEXTURE_2D,this.textures[n].texture,0);this.depthTexture?(this.depthTexture.width=e,this.depthTexture.height=t,this.depthTexture.needsUpdate=!0,this.depthTexture.update(),this.gl.framebufferTexture2D(this.target,this.gl.DEPTH_ATTACHMENT,this.gl.TEXTURE_2D,this.depthTexture.texture,0)):(this.depthBuffer&&(this.gl.bindRenderbuffer(this.gl.RENDERBUFFER,this.depthBuffer),this.gl.renderbufferStorage(this.gl.RENDERBUFFER,this.gl.DEPTH_COMPONENT16,e,t)),this.stencilBuffer&&(this.gl.bindRenderbuffer(this.gl.RENDERBUFFER,this.stencilBuffer),this.gl.renderbufferStorage(this.gl.RENDERBUFFER,this.gl.STENCIL_INDEX8,e,t)),this.depthStencilBuffer&&(this.gl.bindRenderbuffer(this.gl.RENDERBUFFER,this.depthStencilBuffer),this.gl.renderbufferStorage(this.gl.RENDERBUFFER,this.gl.DEPTH_STENCIL,e,t))),this.gl.renderer.bindFramebuffer({target:this.target})}}},yd={black:`#000000`,white:`#ffffff`,red:`#ff0000`,green:`#00ff00`,blue:`#0000ff`,fuchsia:`#ff00ff`,cyan:`#00ffff`,yellow:`#ffff00`,orange:`#ff8000`};function bd(e){e.length===4&&(e=e[0]+e[1]+e[1]+e[2]+e[2]+e[3]+e[3]);let t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t||console.warn(`Unable to convert hex string ${e} to rgb values`),[parseInt(t[1],16)/255,parseInt(t[2],16)/255,parseInt(t[3],16)/255]}function xd(e){return e=parseInt(e),[(e>>16&255)/255,(e>>8&255)/255,(e&255)/255]}function Sd(e){return e===void 0?[0,0,0]:arguments.length===3?arguments:isNaN(e)?e[0]===`#`?bd(e):yd[e.toLowerCase()]?bd(yd[e.toLowerCase()]):(console.warn(`Color format not recognised`),[0,0,0]):xd(e)}var Cd=class extends Array{constructor(e){return super(...Array.isArray(e)?e:Sd(...arguments))}get r(){return this[0]}get g(){return this[1]}get b(){return this[2]}set r(e){this[0]=e}set g(e){this[1]=e}set b(e){this[2]=e}set(e){return Array.isArray(e)?this.copy(e):this.copy(Sd(...arguments))}copy(e){return this[0]=e[0],this[1]=e[1],this[2]=e[2],this}},wd=class extends ql{constructor(e,{attributes:t={}}={}){Object.assign(t,{position:{size:2,data:new Float32Array([-1,-1,3,-1,-1,3])},uv:{size:2,data:new Float32Array([0,0,2,0,0,2])}}),super(e,t)}},Td=12,Ed=8,Dd=`#version 300 es
in vec2 position;
void main() {
...
`,Ad=e=>{let t=e&&e.length?e:[`#ffffff`],n=[];for(let e=0;e<Ed;e++){let r=new Cd(t[e]??t[t.length-1]);n.push([r.r,r.g,r.b])}return n};function jd({colors:e=[`#FF4242`,`#7C3AED`,`#06B6D4`,`#EAB308`],count:t=3,speed:n=.5,amplitude:r=1,waviness:i=1,thickness:a=.7,glow:o=2.6,taper:s=3,spread:c=1,hueShift:l=0,intensity:u=.6,saturation:d=1.5,opacity:f=1,scale:p=1.5,glass:m=!1,refraction:h=1,dispersion:g=1,glassSize:_=1,className:v=``,style:y=void 0}){let b=(0,C.useRef)({});b.current={colors:e,count:t,speed:n,amplitude:r,waviness:i,thickness:a,glow:o,taper:s,spread:c,hueShift:l,intensity:u,saturation:d,opacity:f,scale:p,glass:m,refraction:h,dispersion:g,glassSize:_};let x=(0,C.useRef)(null);return(0,C.useEffect)(()=>{let e=x.current;if(!e)return;let t=new ou({alpha:!0,premultipliedAlpha:!0,antialias:!0}),m=t.gl;m.clearColor(0,0,0,0),m.enable(m.BLEND),m.blendFunc(m.ONE,m.ONE_MINUS_SRC_ALPHA),m.canvas.style.backgroundColor=`transparent`;let v=new wd(m);v.attributes.uv&&delete v.attributes.uv;let y=new Xl(m,{vertex:Dd,fragment:Od,uniforms:{uTime:{value:0},uResolution:{value:[e.offsetWidth,e.offsetHeight]},uColors:{value:Ad(b.current.colors)},uColorCount:{value:Math.min(b.current.colors.length,Ed)},uStrandCount:{value:Math.min(b.current.count,Td)},uSpeed:{value:n},uAmplitude:{value:r},uWaviness:{value:i},uThickness:{value:a},uGlow:{value:o},uTaper:{value:s},uSpread:{value:c},uHueShift:{value:l},uIntensity:{value:u},uOpacity:{value:f},uScale:{value:p},uSaturation:{value:d}}}),S=new md(m,{geometry:v,program:y}),C=new $(m,{width:e.offsetWidth,height:e.offsetHeight}),w=new Xl(m,{vertex:Dd,fragment:kd,uniforms:{uScene:{value:C.texture},uResolution:{value:[e.offsetWidth,e.offsetHeight]},uRadius:{value:.46*_},uRefraction:{value:h},uDispersion:{value:g}}}),T=new md(m,{geometry:v,program:w});e.appendChild(m.canvas);function E(){let n=e.offsetWidth,r=e.offsetHeight;t.setSize(n,r),y.uniforms.uResolution.value=[n,r],C.setSize(n,r),w.uniforms.uResolution.value=[n,r]}window.addEventListener(`resize`,E),E();let D=0,O=e=>{D=requestAnimationFrame(O);let n=b.current;y.uniforms.uTime.value=e*.001,y.uniforms.uColors.value=Ad(n.colors),y.uniforms.uColorCount.value=Math.min(n.colors.length,Ed),y.uniforms.uStrandCount.value=Math.min(Math.max(Math.round(n.count),1),Td);for(let e of[`Speed`,`Amplitude`,`Waviness`,`Thickness`,`Glow`,`Taper`,`Spread`,`HueShift`,`Intensity`,`Opacity`,`Scale`,`Saturation`])y.uniforms[`u${e}`].value=n[e.charAt(0).toLowerCase()+e.slice(1)];n.glass?(t.render({scene:S,target:C}),w.uniforms.uScene.value=C.texture,w.uniforms.uRefraction.value=n.refraction,w.uniforms.uDispersion.value=n.dispersion,w.uniforms.uRadius.value=.46*n.glassSize,t.render({scene:T})):t.render({scene:S})};return D=requestAnimationFrame(O),()=>{cancelAnimationFrame(D),window.removeEventListener(`resize`,E),e&&m.canvas.parentNode===e&&e.removeChild(m.canvas),m.getExtension(`WEBGL_lose_context`)?.loseContext()}},[]),(0,Z.jsx)(`div`,{ref:x,className:`strands-container ${v}`,style:y})}function Md(){return typeof window<`u`&&!!window.__TAURI_INTERNALS__}function Nd(e){return e.token?`connected`:e.desktop?`desktop-disconnected`:`pairing`}function Pd(){return localStorage.getItem(`salar.deviceSession`)||localStorage.getItem(`salar.token`)||``}function Fd(e){localStorage.setItem(`salar.deviceSession`,e),localStorage.removeItem(`salar.token`)}function Id(){localStorage.removeItem(`salar.deviceSession`),localStorage.removeItem(`salar.token`)}localStorage.getItem(`salar.apiUrl`);var Ld=`https://api.salar.example.com`.replace(/\/$/,``),Rd=new class{baseUrl;token;constructor(e=Ld,t=localStorage.getItem(`salar.deviceSession`)||localStorage.getItem(`salar.token`)||``){this.baseUrl=e,this.token=t}async request(e,t={}){let n=new Headers(t.headers);this.token&&n.set(`Authorization`,`Bearer ${this.token}`),t.body&&!(t.body instanceof FormData)&&n.set(`Content-Type`,`application/json`);let r=await fetch(`${this.baseUrl}${e}`,{...t,headers:n});if(!r.ok)throw Error((await r.json().catch(()=>null))?.detail||`Request failed (${r.status})`);return r.json()}async login(e,t){let n=await this.request(`/api/auth/login`,{method:`POST`,body:JSON.stringify({email:e,password:t})});return this.token=n.access_token,localStorage.setItem(`salar.token`,n.access_token),n}async provisionDesktop(e,t=`SALAR Desktop`){let n=await this.request(`/api/auth/desktop/provision`,{method:`POST`,body:JSON.stringify({provisioning_key:e,name:t})});return this.token=n.access_token,n}validateSession(){return this.request(`/api/auth/session`)}createPairingCode(){return this.request(`/api/auth/pairing`,{method:`POST`})}async redeemPairingCode(e,t,n){let r=await this.request(`/api/auth/pairing/redeem`,{method:`POST`,body:JSON.stringify({code:e,name:t,platform:n})});return this.token=r.access_token,r}deviceSessions(){return this.request(`/api/auth/devices`)}revokeDeviceSession(e){return this.request(`/api/auth/devices/${e}`,{method:`DELETE`})}conversations(){return this.request(`/api/conversations`)}conversation(e){return this.request(`/api/conversations/${e}`)}createConversation(e=`New conversation`){return this.request(`/api/conversations`,{method:`POST`,body:JSON.stringify({title:e})})}chat(e,t){return this.request(`/api/chat`,{method:`POST`,body:JSON.stringify({conversation_id:e,content:t})})}memories(){return this.request(`/api/memory`)}saveMemory(e,t){return this.request(`/api/memory`,{method:`POST`,body:JSON.stringify({title:e,content:t,layer:`long_term`})})}documents(){return this.request(`/api/documents`)}async upload(e){let t=new FormData;return t.append(`file`,e),this.request(`/api/documents`,{method:`POST`,body:t})}devices(){return this.request(`/api/devices`)}registerDevice(e,t=`windows`){return this.request(`/api/devices`,{method:`POST`,body:JSON.stringify({name:e,platform:t})})}command(e,t,n){return this.request(`/api/commands`,{method:`POST`,body:JSON.stringify({device_id:e,kind:t,payload:n})})}async nextDeviceCommand(e){let t=await fetch(`${this.baseUrl}/api/device/commands/next`,{headers:{"X-Device-Token":e}});if(!t.ok)throw Error(`Device link rejected`);return t.json()}async completeDeviceCommand(e,t,n){return fetch(`${this.baseUrl}/api/device/commands/${e}/result`,{method:`POST`,headers:{"Content-Type":`application/json`,"X-Device-Token":t},body:JSON.stringify({...n,data:n.data||{}})})}},zd=new URLSearchParams(location.search).get(`preview`)===`dashboard`;function Bd(){return(0,Z.jsxs)(`main`,{className:`loader`,children:[(0,Z.jsx)(`div`,{className:`loader-effect`,children:(0,Z.jsx)(jd,{colors:[`#F97316`,`#7C3AED`,`#06B6D4`],count:3,speed:.5,amplitude:1,waviness:1,thickness:.7,glow:2.6,taper:3,spread:1,intensity:.6,saturation:1.5,opacity:1,scale:1.5,glass:!1,refraction:1,dispersion:1,glassSize:1})}),(0,Z.jsxs)(`div`,{className:`loader-copy`,children:[(0,Z.jsx)(`p`,{children:`SALAR`}),(0,Z.jsx)(`span`,{children:`INITIALIZING PRIVATE INTELLIGENCE`})]})]})}function Vd({onConnected:e}){let[t,n]=(0,C.useState)(``),[r,i]=(0,C.useState)(``),[a,o]=(0,C.useState)(!1);async function s(n){if(n.preventDefault(),t.length!==6)return i(`Enter the six-digit code shown by SALAR Desktop.`);o(!0),i(``);try{Fd((await Rd.redeemPairingCode(t,navigator.userAgent.includes(`iPhone`)?`JD iPhone`:`Web browser`,navigator.userAgent.includes(`iPhone`)?`ios`:`web`)).access_token),e()}catch(e){i(e.message)}finally{o(!1)}}return(0,Z.jsxs)(`main`,{className:`pairing-screen`,children:[(0,Z.jsx)(`div`,{className:`pairing-ether`,children:(0,Z.jsx)(hl,{colors:[`#5227FF`,`#FF9FFC`,`#B497CF`],mouseForce:20,cursorSize:100,resolution:.5,autoDemo:!0,autoSpeed:.5,autoIntensity:2.2})}),(0,Z.jsxs)(`form`,{className:`pairing-panel`,onSubmit:s,children:[(0,Z.jsx)(`div`,{className:`salar-glyph`,children:`S`}),(0,Z.jsx)(`span`,{className:`eyebrow`,children:`PRIVATE DEVICE LINK`}),(0,Z.jsx)(`h1`,{children:`Pair with SALAR`}),(0,Z.jsx)(`p`,{children:`On SALAR Desktop, open Settings and choose “Pair a device.”`}),(0,Z.jsxs)(`label`,{children:[`Six-digit code`,(0,Z.jsx)(`input`,{autoFocus:!0,inputMode:`numeric`,maxLength:6,value:t,onChange:e=>n(e.target.value.replace(/\D/g,``).slice(0,6)),placeholder:`000000`})]}),r&&(0,Z.jsx)(`div`,{className:`inline-error`,children:r}),(0,Z.jsxs)(`button`,{disabled:a||t.length!==6,children:[a?`Pairing…`:`Pair device`,` `,(0,Z.jsx)(k,{size:17})]}),(0,Z.jsxs)(`small`,{children:[`Codes expire after five minutes · `,Rd.baseUrl]})]})]})}function Hd(){let e=Md()||zd,[t,n]=(0,C.useState)(!1),[r,i]=(0,C.useState)(()=>Nd({desktop:e,token:Pd()})),[a,o]=(0,C.useState)(`home`),[s,c]=(0,C.useState)(!1),[l,u]=(0,C.useState)(!1);if((0,C.useEffect)(()=>{let e=setTimeout(()=>n(!0),1700);return()=>clearTimeout(e)},[]),(0,C.useEffect)(()=>{r===`connected`&&Rd.validateSession().catch(()=>{Id(),Rd.token=``,i(e?`desktop-disconnected`:`pairing`)})},[r,e]),(0,C.useEffect)(()=>{let e=window.__TAURI_INTERNALS__?.invoke,t=Pd();if(r!==`connected`||!e||!t)return;let n=!1,i=0;async function a(){try{let n=await Rd.nextDeviceCommand(t);if(n)try{let r=await e(`execute_device_command`,{kind:n.kind,payload:n.payload});await Rd.completeDeviceCommand(n.id,t,{ok:!0,detail:`Executed by SALAR Desktop`,data:r})}catch(e){await Rd.completeDeviceCommand(n.id,t,{ok:!1,detail:String(e)})}}catch{}finally{n||(i=window.setTimeout(a,1800))}}return a(),()=>{n=!0,clearTimeout(i)}},[r]),!t)return(0,Z.jsx)(Bd,{});if(!e&&r===`pairing`)return(0,Z.jsx)(Vd,{onConnected:()=>i(`connected`)});let d=[[`home`,ae,`Intelligence`],[`memory`,te,`Memory`],[`documents`,ee,`Documents`],[`devices`,re,`Devices`],[`settings`,ie,`Settings`]];return(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsxs)(`main`,{className:`app-shell${s?` live-open`:``}`,children:[(0,Z.jsx)(`div`,{className:`liquid-stage`,children:(0,Z.jsx)(hl,{colors:[`#5227FF`,`#FF9FFC`,`#B497CF`],mouseForce:20,cursorSize:100,isViscous:!1,viscous:30,iterationsViscous:32,iterationsPoisson:32,resolution:.5,isBounce:!1,autoDemo:!0,autoSpeed:.5,autoIntensity:2.2,takeoverDuration:.25,autoResumeDelay:3e3,autoRampDuration:.6})}),(0,Z.jsxs)(`header`,{className:`topbar`,children:[(0,Z.jsx)(`button`,{className:`mobile-menu`,onClick:()=>u(!l),children:(0,Z.jsx)(j,{})}),(0,Z.jsxs)(`div`,{className:`brand`,children:[(0,Z.jsx)(`div`,{className:`salar-glyph`,children:`S`}),(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`b`,{children:`SALAR`}),(0,Z.jsx)(`small`,{children:`PERSONAL INTELLIGENCE`})]})]}),(0,Z.jsx)(`nav`,{className:`topnav`,children:d.slice(0,4).map(([e,,t])=>(0,Z.jsx)(`button`,{className:a===e?`active`:``,onClick:()=>o(e),children:t},e))}),(0,Z.jsxs)(`button`,{className:`connection ${r}`,onClick:()=>o(`settings`),children:[(0,Z.jsx)(`i`,{}),r===`connected`?`SECURE LINK`:`CONNECT`]})]}),(0,Z.jsx)(`aside`,{className:l?`open`:``,children:d.map(([e,t,n])=>(0,Z.jsxs)(`button`,{className:a===e?`active`:``,onClick:()=>{o(e),u(!1)},children:[(0,Z.jsx)(t,{size:17}),(0,Z.jsx)(`span`,{children:n})]},e))}),(0,Z.jsxs)(`section`,{className:`workspace`,children:[a===`home`&&(0,Z.jsx)(Ud,{connected:r===`connected`,onLive:()=>c(!0),onConnect:()=>o(`settings`)}),a===`memory`&&(0,Z.jsx)(Gd,{connected:r===`connected`}),a===`documents`&&(0,Z.jsx)(Kd,{connected:r===`connected`}),a===`devices`&&(0,Z.jsx)(qd,{connected:r===`connected`}),a===`settings`&&(0,Z.jsx)(Jd,{access:r,onAccess:i})]})]}),s&&(0,Z.jsx)(Wd,{connected:r===`connected`,onClose:()=>c(!1)})]})}function Ud({connected:e,onLive:t,onConnect:n}){let[r,i]=(0,C.useState)(null),[a,o]=(0,C.useState)([]),[s,c]=(0,C.useState)(``),[l,u]=(0,C.useState)(!1),[d,f]=(0,C.useState)(``),p=(0,C.useRef)(null);(0,C.useEffect)(()=>{e&&Rd.conversations().then(async e=>{let t=e[0]||await Rd.createConversation();i(t),e[0]&&o((await Rd.conversation(t.id)).messages||[])}).catch(e=>f(e.message))},[e]),(0,C.useEffect)(()=>p.current?.scrollIntoView({behavior:`smooth`}),[a]);async function m(){if(!s.trim()||!r||l)return;let e=s;c(``),u(!0);try{let t=await Rd.chat(r.id,e);o(e=>[...e,t.user_message,t.assistant_message])}catch(e){f(e.message)}finally{u(!1)}}return(0,Z.jsxs)(`div`,{className:`chat-view`,children:[(0,Z.jsxs)(`div`,{className:`hero`,children:[(0,Z.jsx)(`span`,{className:`eyebrow`,children:`COORDINATED INTELLIGENCE`}),(0,Z.jsx)(`h1`,{children:a.length?`Command stream`:`What shall we accomplish?`}),(0,Z.jsx)(`p`,{children:`Private intelligence, memory, knowledge, and your connected devices—coordinated from one place.`}),!e&&(0,Z.jsxs)(`button`,{className:`text-action`,onClick:n,children:[(0,Z.jsx)(oe,{size:15}),` Connect the private backend`]})]}),(0,Z.jsxs)(`div`,{className:`messages`,children:[a.map(e=>(0,Z.jsxs)(`article`,{className:e.role,children:[(0,Z.jsx)(`span`,{children:e.role===`assistant`?`SALAR`:`YOU`}),(0,Z.jsx)(`p`,{children:e.content})]},e.id)),l&&(0,Z.jsxs)(`article`,{className:`assistant thinking`,children:[(0,Z.jsx)(`span`,{children:`SALAR`}),(0,Z.jsx)(`p`,{children:`Reasoning across your private context…`})]}),(0,Z.jsx)(`div`,{ref:p})]}),d&&(0,Z.jsx)(`div`,{className:`toast`,children:d}),(0,Z.jsxs)(`div`,{className:`composer`,children:[(0,Z.jsx)(`button`,{className:`icon-control live-control`,onClick:t,title:`Enter Live mode`,children:(0,Z.jsx)(ne,{})}),(0,Z.jsx)(`textarea`,{value:s,onChange:e=>c(e.target.value),onKeyDown:e=>{e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),m())},placeholder:e?`Ask, create, search, or control…`:`Connect SALAR in Settings to begin…`,disabled:!e,rows:1}),(0,Z.jsx)(`button`,{className:`icon-control send-control`,onClick:m,disabled:!e||l||!s.trim(),title:`Send command`,children:(0,Z.jsx)(N,{})})]})]})}function Wd({connected:e,onClose:t}){let[n,r]=(0,C.useState)(e?`Listening for your command…`:`Connect SALAR before using Live Mode.`),[i,a]=(0,C.useState)(``);return(0,C.useEffect)(()=>{if(!e)return;let t=!0,n=``,i=window.SpeechRecognition||window.webkitSpeechRecognition;if(!i){r(`Voice recognition is unavailable on this device.`);return}let o=new i;return o.continuous=!0,o.interimResults=!0,Rd.createConversation(`Live session`).then(e=>n=e.id),o.onresult=async e=>{for(let i=e.resultIndex;i<e.results.length;i++){let o=e.results[i][0].transcript;if(r(o),e.results[i].isFinal&&n){let e=await Rd.chat(n,o);if(!t)return;a(e.assistant_message.content),speechSynthesis.cancel(),speechSynthesis.speak(new SpeechSynthesisUtterance(e.assistant_message.content))}}},o.start(),()=>{t=!1,o.stop(),speechSynthesis.cancel()}},[e]),(0,Z.jsxs)(`main`,{className:`live`,children:[(0,Z.jsx)(`div`,{className:`rings`,children:(0,Z.jsx)(vl,{color:`#fc42ff`,colorTwo:`#42fcff`,ringCount:6,speed:1,attenuation:10,lineThickness:2,baseRadius:.35,radiusStep:.1,scaleRate:.1,opacity:1,blur:0,noiseAmount:.1,rotation:0,ringGap:1.5,fadeIn:.7,fadeOut:.5,followMouse:!1,mouseInfluence:.2,hoverScale:1.2,parallax:.05,clickBurst:!1})}),(0,Z.jsx)(`button`,{className:`close`,onClick:t,children:(0,Z.jsx)(se,{})}),(0,Z.jsxs)(`div`,{className:`live-copy`,children:[(0,Z.jsx)(`span`,{className:`eyebrow`,children:`LIVE MODE · CONTINUOUS`}),(0,Z.jsx)(`h1`,{children:`SALAR is listening`}),(0,Z.jsx)(`p`,{children:n}),i&&(0,Z.jsx)(`blockquote`,{children:i})]})]})}function Gd({connected:e}){let[t,n]=(0,C.useState)([]);return(0,C.useEffect)(()=>{e&&Rd.memories().then(n)},[e]),(0,Z.jsx)(Yd,{title:`Memory`,subtitle:`Facts and decisions SALAR carries forward.`,children:(0,Z.jsxs)(`div`,{className:`grid`,children:[t.map(e=>(0,Z.jsx)(Xd,{icon:(0,Z.jsx)(O,{}),title:e.title,text:e.content},e.id)),(0,Z.jsx)(Xd,{icon:(0,Z.jsx)(M,{}),title:e?`Add through conversation`:`Backend disconnected`,text:e?`Ask SALAR to remember anything important.`:`Provision this device in Settings.`})]})})}function Kd({connected:e}){let[t,n]=(0,C.useState)([]),r=(0,C.useRef)(null);(0,C.useEffect)(()=>{e&&Rd.documents().then(n)},[e]);async function i(e){if(e){let t=await Rd.upload(e);n(e=>[t,...e])}}return(0,Z.jsxs)(Yd,{title:`Knowledge`,subtitle:`Search documents, notes, and source code.`,children:[e&&(0,Z.jsxs)(`button`,{className:`primary`,onClick:()=>r.current?.click(),children:[(0,Z.jsx)(M,{size:16}),` Index document`]}),(0,Z.jsx)(`input`,{ref:r,hidden:!0,type:`file`,onChange:e=>i(e.target.files?.[0])}),(0,Z.jsx)(`div`,{className:`grid`,children:t.map(e=>(0,Z.jsx)(Xd,{icon:(0,Z.jsx)(ee,{}),title:e.filename,text:e.media_type},e.id))})]})}function qd({connected:e}){let[t,n]=(0,C.useState)([]);return(0,C.useEffect)(()=>{e&&Rd.devices().then(n)},[e]),(0,Z.jsx)(Yd,{title:`Connected devices`,subtitle:`Permission-aware control through your private backend.`,children:(0,Z.jsxs)(`div`,{className:`grid`,children:[t.map(e=>(0,Z.jsx)(Xd,{icon:(0,Z.jsx)(re,{}),title:e.name,text:`${e.platform} · ${e.last_seen_at?`online recently`:`registered`}`},e.id)),!t.length&&(0,Z.jsx)(Xd,{icon:(0,Z.jsx)(A,{}),title:e?`No command devices linked`:`Backend disconnected`,text:e?`SALAR Desktop registers automatically after provisioning.`:`Open Settings to connect this installation.`})]})})}function Jd({access:e,onAccess:t}){let[n,r]=(0,C.useState)(localStorage.getItem(`salar.apiUrl`)||Ld),[i,a]=(0,C.useState)(``),[o,s]=(0,C.useState)(null),[c,l]=(0,C.useState)(``);async function u(){try{localStorage.setItem(`salar.apiUrl`,n),Rd.baseUrl=n.replace(/\/$/,``),Fd((await Rd.provisionDesktop(i)).access_token),a(``),t(`connected`),l(`This desktop is securely connected.`)}catch(e){l(e.message)}}async function d(){try{s(await Rd.createPairingCode())}catch(e){l(e.message)}}return(0,Z.jsx)(Yd,{title:`Settings`,subtitle:`One private backend across desktop, web, and iPhone.`,children:(0,Z.jsxs)(`section`,{className:`settings-card`,children:[(0,Z.jsxs)(`label`,{children:[`Public API address`,(0,Z.jsx)(`input`,{value:n,onChange:e=>r(e.target.value),placeholder:`https://api.yourdomain.com`})]}),e===`connected`?(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsxs)(`div`,{className:`connected-row`,children:[(0,Z.jsx)(`i`,{}),` Desktop session active`]}),(0,Z.jsx)(`button`,{className:`primary`,onClick:d,children:`Pair another device`}),o&&(0,Z.jsxs)(`div`,{className:`pairing-code`,children:[(0,Z.jsx)(`span`,{children:o.code}),(0,Z.jsx)(`small`,{children:`Expires in five minutes`})]}),(0,Z.jsx)(`button`,{className:`text-action danger`,onClick:()=>{Id(),Rd.token=``,t(`desktop-disconnected`)},children:`Disconnect this desktop`})]}):(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsxs)(`label`,{children:[`One-time provisioning key`,(0,Z.jsx)(`input`,{type:`password`,value:i,onChange:e=>a(e.target.value),placeholder:`From your private backend .env`})]}),(0,Z.jsx)(`button`,{className:`primary`,disabled:!i,onClick:u,children:`Connect this desktop`}),(0,Z.jsx)(`p`,{children:`The key is exchanged for a revocable machine credential and is never stored.`})]}),c&&(0,Z.jsx)(`div`,{className:`notice`,children:c})]})})}function Yd({title:e,subtitle:t,children:n}){return(0,Z.jsxs)(`div`,{className:`page`,children:[(0,Z.jsx)(`span`,{className:`eyebrow`,children:`SALAR WORKSPACE`}),(0,Z.jsx)(`h1`,{children:e}),(0,Z.jsx)(`p`,{children:t}),n]})}function Xd({icon:e,title:t,text:n}){return(0,Z.jsxs)(`article`,{className:`card`,children:[(0,Z.jsx)(`div`,{children:e}),(0,Z.jsx)(`h3`,{children:t}),(0,Z.jsx)(`p`,{children:n})]})}(0,ce.createRoot)(document.getElementById(`root`)).render((0,Z.jsx)(Hd,{}));